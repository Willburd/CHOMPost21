/datum/map/outpost_ocean
	name = "Outpost 22"
	full_name = "ESHUI Terraforming Observation Outpost 22"
	path = "outpost"
	...
	station_name  = "ESHUI Terraforming Observation Outpost 22"
	station_short = "Outpost 22"
