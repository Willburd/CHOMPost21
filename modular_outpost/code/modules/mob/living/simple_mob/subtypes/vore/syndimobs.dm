...
//Serdy's syndie subtypes, but tweaked to make it make sense.
...
/mob/living/simple_mob/vore/otie/syndicate //Spawn this one only if you're looking for a bad time. Not friendly.
	...
	armor = list(		// Values for normal getarmor() checks //OP edit: Half the values of the actual syndies, rounded down.
				"melee" = 37,
				"bullet" = 30,
				"laser" = 20,
				"energy" = 7,
	...
	armor_soak = list(		// Values for getsoak() checks.
				"melee" = 0, //OP Edit: all set to 0, upstream wants to move away from armor soak apparently
				"bullet" = 0,
				"laser" = 0,
				"energy" = 0,
				"bomb" = 0,
...
/mob/living/simple_mob/vore/wolftaur/syndicate
	...
	projectiletype = /obj/item/projectile/bullet/rifle/a762 //OP edit - This is the bullet the Z8 actually fires
	...
	armor = list(			// Values for normal getarmor() checks
				...
				"bomb" = 545, //OP - was 50
				"bio" = 100, //OP - was 100
				"rad" = 100 //OP - Actual should be 60, but mobs get REALLY unhappy and break with less than 100 rad
				) //OP edit - Changes these values to match wearing an actual syndie suit. They're as close to 1-1 as I can get
...
/mob/living/simple_mob/vore/wolftaur/syndicate/lmg
	...
	projectiletype = /obj/item/projectile/bullet/rifle/a545 //OP edit: Fixes this to use the same bullet as the actual LMG
	projectilesound = 'sound/weapons/ballistics/a545.ogg'
	projectile_dispersion = 8 //OP edit, was 12. Lowering cuz these are trained taurs in a full suit. C'mon
	projectile_accuracy = -18 //OP edit, was -25
	random_skin = 0
...
/mob/living/simple_mob/vore/wolftaur/syndicate/smg
	...
	projectiletype = /obj/item/projectile/bullet/pistol //OP edit: The actual bullet the p90 uses. Technically this one is a nerf.
	projectilesound = 'sound/weapons/ballistics/a545.ogg'
