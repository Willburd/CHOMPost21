...
#define EXPORT_VALUE_COMMON 0.6 SHEET_TO_REAGENT_EQUIVILENT		// 150 per tank
#define EXPORT_VALUE_RARE 1 SHEET_TO_REAGENT_EQUIVILENT			// 250 per tank
#define EXPORT_VALUE_PROCESSED 2 SHEET_TO_REAGENT_EQUIVILENT	// 500 per tank
#define EXPORT_VALUE_HIGHREFINED 3 SHEET_TO_REAGENT_EQUIVILENT	// 750 per tank
#define EXPORT_VALUE_MASSINDUSTRY 4 SHEET_TO_REAGENT_EQUIVILENT	// 1000 per tank
#define EXPORT_VALUE_PEAK 8 SHEET_TO_REAGENT_EQUIVILENT			// 2000 per tank
#define EXPORT_VALUE_GODTIER 16 SHEET_TO_REAGENT_EQUIVILENT		// 4000 per tank
