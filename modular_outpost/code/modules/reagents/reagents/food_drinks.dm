...
/datum/reagent/drink/coffee/nukie/mega/final_nukie/affect_ingest(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/ickypak/the_dew/affect_blood(var/mob/living/carbon/M, alien, removed)
