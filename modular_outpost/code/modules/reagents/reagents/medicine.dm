...
/datum/reagent/hemocyanin/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/hemocyanin/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/toxin/fenthol/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/toxin/fenthol/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA || alien == IS_VOX)
		return
