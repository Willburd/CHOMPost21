/datum/design_techweb/aimodule/eshui
	...
	departmental_flags = DEPARTMENT_BITFLAG_SCIENCE | DDEPARTMENT_BITFLAG_ENGINEERING


// Overrides
/datum/design_techweb/board/aicore
	departmental_flags = DDEPARTMENT_BITFLAG_SCIENCE | DDEPARTMENT_BITFLAG_ENGINEERING
