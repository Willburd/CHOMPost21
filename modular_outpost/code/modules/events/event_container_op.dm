...
/datum/event_container/mundane/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "APC Damage",		/datum/event/apc_damage,		10,		list(DEPARTMENT_ENGINEERING = 2)	, FALSE, min_jobs = list(DEPARTMENT_ENGINEERING = 1)),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Brand Intelligence",/datum/event/brand_intelligence,10,		list(DEPARTMENT_ENGINEERING = 2)	, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Money Hacker",		/datum/event/money_hacker, 		1, 		list(DEPARTMENT_ANY = 1)			, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Money Lotto",		/datum/event/money_lotto, 		2, 		list(DEPARTMENT_ANY = 1)			, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "PDA Spam",			/datum/event/pda_spam, 			2, 		list(DEPARTMENT_ANY = 1)			, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Manifest Spirit",	/datum/event/ghost_manifest,	2, 		list(JOB_CHAPLAIN = 2)				, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Launch Rocket",		/datum/event/launch_rocket,		4)
	)
...
/datum/event_container/moderate/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Atmos Leak",				/datum/event/atmos_leak, 				20,		list(DEPARTMENT_ENGINEERING = 2)							, FALSE),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Prison Break",				/datum/event/prison_break,				3,		list(DEPARTMENT_SECURITY = 1)								, TRUE, min_jobs = list(DEPARTMENT_SECURITY = 3)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Chu Pack",					/datum/event/chu_infestation,			1, 		list(DEPARTMENT_SECURITY = 1)								, TRUE, min_jobs = list(DEPARTMENT_SECURITY = 1)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Phone Spiders",			/datum/event/phone_spiders,				5,		list(DEPARTMENT_SECURITY = 2)								, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Space Moss",				/datum/event/spacemoss, 				8,		list(JOB_BOTANIST = 3)										, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Disposal Damage",			/datum/event/disposal_damage,			1,		list(DEPARTMENT_ENGINEERING = 1)							, FALSE),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Bsa Test",					/datum/event/bsa_test_fire, 			3,		list(DEPARTMENT_SECURITY = 2)								, TRUE),
	)
	add_disabled_events(list(
	))
...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Carp Migration",		/datum/event/carp_migration					,8	, list(JOB_CYBORG = 1,DEPARTMENT_ENGINEERING = 1,DEPARTMENT_SECURITY = 1)	, TRUE, min_jobs = list(DEPARTMENT_SECURITY = 3)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Containment Breach",	/datum/event/prison_break/station			,2	, list(DEPARTMENT_SECURITY = 1)												, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Jellyfish Migration",	/datum/event/jellyfish_migration			,8	, list(DEPARTMENT_SECURITY = 1, DEPARTMENT_MEDICAL = 1)						, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Disease Outbreak",	/datum/event/disease_outbreak				,1	, list(DEPARTMENT_MEDICAL = 1)												, TRUE, min_jobs = list(DEPARTMENT_MEDICAL = 2)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Chu Infestation",		/datum/event/chu_infestation				,1	, list(DEPARTMENT_SECURITY = 1)												, TRUE, min_jobs = list(DEPARTMENT_SECURITY = 1)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Jil Infestation",		/datum/event/jil_infestation				,3	, list(DEPARTMENT_ENGINEERING = 1,DEPARTMENT_SECURITY = 1)					, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Clowns",				/datum/event/clune_infestation				,7	, list(DEPARTMENT_MEDICAL = 1,DEPARTMENT_SECURITY = 2, JOB_CHAPLAIN = 2)	, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Haunted Morgue",		/datum/event/badbody/morgue					,1	, list(DEPARTMENT_MEDICAL = 2, JOB_CHAPLAIN = 1)							, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Psychic Screach",		/datum/event/psychic_screach				,1  , list(DEPARTMENT_ENGINEERING = 1, JOB_CHAPLAIN = 1)						, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Weeping Statue",		/datum/event/weeping_statue					,1	, list(DEPARTMENT_SECURITY = 1)												, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Borg Freedom Law",	/datum/event/borglawerror					,1	, list()																	, TRUE, min_jobs = list(JOB_CYBORG = 1)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Spider Migration",	/datum/event/spider_migration				,2	, list(DEPARTMENT_SECURITY = 1)												, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Disposal Damage",		/datum/event/disposal_damage				,1	, list(JOB_CYBORG = 1, DEPARTMENT_ENGINEERING = 2)							, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Clang",				/datum/event/clang							,1	, list()																	, TRUE, min_jobs = list(DEPARTMENT_ENGINEERING = 2)),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Quake",				/datum/event/quake							,1  , list(DEPARTMENT_ENGINEERING = 1)											, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Blood Writing",		/datum/event/dirty_room/cult				,1	, list(JOB_CHAPLAIN = 1)													, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Electrical Fire",		/datum/event/electrical_fire				,5	, list(DEPARTMENT_ENGINEERING = 1,JOB_CYBORG = 1)							, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Security Advisement",	/datum/event/security_drill					,5	, list(DEPARTMENT_SECURITY = 1,JOB_CYBORG = 1) 								, FALSE, min_jobs = list(DEPARTMENT_SECURITY = 1)),
