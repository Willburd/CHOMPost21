...
/datum/event_container/mundane/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "APC Damage",		/datum/event/apc_damage,		2,	null, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Brand Intelligence",/datum/event/brand_intelligence,2,	null, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Camera Damage",		/datum/event/camera_damage,		2,  null, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Canister Leak",		/datum/event/canister_leak,		3,  null, FALSE),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Space Dust",		/datum/event/dust,	 			1, 	null, FALSE),
...
/datum/event_container/moderate/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Space Dust",				/datum/event/dust,	 					3,		null, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Chu Pack",					/datum/event/chu_infestation,			2, 		null, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Hostile Runtime", 			/datum/event/hostile_runtime, 			2, 		null, FALSE),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Pyroclastic Anomaly", 		/datum/event/anomaly/pyro,				1,		null, TRUE, min_jobs = list(DEPARTMENT_RESEARCH = 1)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Septic Explosion",			/datum/event/septic_explosion,			1, 		null, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Tram Fuse Blown",			/datum/event/tram_breaker,				1,		null, TRUE),
	)
	add_disabled_events(list(
	))
...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Meaty Ores Wave", 	/datum/event/meteor_wave/meatyores			,2	, null, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Chu Infestation",		/datum/event/chu_infestation				,2	, null, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Clang",				/datum/event/clang							,2	, null, TRUE, min_jobs = list(DEPARTMENT_ENGINEERING = 1)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Horde Infestation",	/datum/event/horde_infestation				,3	, null, FALSE),
