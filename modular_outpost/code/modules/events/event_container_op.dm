...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Chu Infestation",		/datum/event/chu_infestation				,1	, list(ASSIGNMENT_SECURITY = 1)												, TRUE, min_jobs = list(ASSIGNMENT_SECURITY = 1)),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Redspace",			/datum/event/redspacefissure				,4	, list()																	, TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Haunted Body",		/datum/event/badbody						,1	, list(ASSIGNMENT_CARGO = 1)												, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Weeping Statue",		/datum/event/weeping_statue					,0	, list(ASSIGNMENT_SECURITY = 1)												, TRUE),
