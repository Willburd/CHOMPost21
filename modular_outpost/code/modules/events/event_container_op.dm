...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Redspace",			/datum/event/redspacefissure				,2	, list()																	, TRUE),
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Weeping Statue",		/datum/event/weeping_statue					,0	, list(ASSIGNMENT_CHAPLAIN = 1,ASSIGNMENT_SECURITY = 1)	, TRUE),
