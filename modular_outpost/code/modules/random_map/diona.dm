...
/turf/simulated/wall/diona/attack_generic(var/mob/user, var/damage, attack_message)
...
/obj/structure/diona/bulb/sea_of_stars/attack_generic(var/mob/user, var/damage, attack_message)
	var/mob/living/carbon/human/H = user
