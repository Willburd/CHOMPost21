...
/datum/player_tips/proc/pick_tip(var/isSpecific)
	...
	switch(choice)
		if("general")
			var/info = "The following is a general tip for playing on Outpost21! You can disable them using the periodic tips toggle in the Global tab of the character setup! \n"
			return pick(
		...
		if("gameplay")
			var/info = "The following is a gameplay-focused tip for playing on Outpost21! You can disable them using the periodic tips toggle in the Global tab of the character setup! \n"
			return pick(
				...
				prob(30); "[info] The weather here on Muriki is hostile; Rain, fog, and the river are all acidic. Be careful when venturing outside!",
		...
		if("roleplay")
			var/info = "The following is a roleplay-focused tip for playing on Outpost21! You can disable them using the periodic tips toggle in the Global tab of the character setup! \n"
			return pick(
