...
/obj/machinery/computer/supply_request_computeralt/attackby(var/obj/item/O as obj, mob/user as mob)
...
/obj/machinery/requests_console/audible_message(var/message, var/deaf_message, var/hearing_distance, var/radio_message, runemessage)
	if(istype(loc,/obj/machinery/computer/supply_request_computeralt))
