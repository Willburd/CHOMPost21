...
/obj/machinery/auto_doc/proc/create_tools()
	tools = list()
	tools[TOOL_SCALPEL] 	= new /obj/item/surgical/scalpel(src)
	tools[TOOL_HEMOSTAT] 	= new /obj/item/surgical/hemostat(src)
	tools[TOOL_RETRACTOR] 	= new /obj/item/surgical/retractor(src)
	tools[TOOL_DRILL] 		= new /obj/item/surgical/surgicaldrill(src)
	tools[TOOL_SAW] 		= new /obj/item/surgical/circular_saw(src)
	tools[TOOL_BONESET] 	= new /obj/item/surgical/bonesetter(src)
	tools[TOOL_FIXVEIN] 	= new /obj/item/surgical/FixOVein(src)
	tools[TOOL_BONEGEL] 	= new /obj/item/surgical/bonegel(src)
	tools[TOOL_CAUTERY] 	= new /obj/item/surgical/cautery(src)
	tools[TOOL_BIOGEN] 		= new /obj/item/surgical/bioregen(src)
...
/proc/autodoc_surgery_step_select( var/user, list/available_surgeries, window_desc, window_title )
...
/proc/autodoc_organ_select( var/user, var/mob/living/carbon/human/target, list/named_organ_to_tag_list, window_desc, window_title )
