...
/obj/item/rectape/anna_lore/Initialize(mapload)
	...
	switch(rand(1,21))
		...
		if(20)
			add_custom_entry( 0, 3, "Recording started.")
			add_custom_entry( 0, 13, "Ludwig says, 'Is this thing on...? Ah, yes. Yes it is.'")
			add_custom_entry( 0, 29, "Ludwig says, 'Rrrright! This is... The doctorr. You all know me! I patched up some of you.'")
			add_custom_entry( 0, 52, "Ludwig shouts, 'I was... Caught by Securrity, when I was looking thrrrrough maintenance. Some of you I have trrreated, some not... But I'm alrright!'")
			add_custom_entry( 1, 12, "Ludwig says, 'They asked me about some questions, but made surrre I was alrright afterr all.'")
			add_custom_entry( 1, 24, "Ludwig says, 'Howeverrr, I won't be allowed to trrreat morrrre patients therrre, any morrre...'")
			add_custom_entry( 1, 42, "Ludwig says, 'So, ah- If any of you everrrr get hurrt. Trrrry and help each otherrrr! My tools arre at yourr disposal.'")
			add_custom_entry( 1, 52, "Ludwig exclaims, 'Stay safe therrre!'")
			add_custom_entry( 2, 06, "Ludwig says, 'How do I turrn thi-'")
			add_custom_entry( 2, 07, "Recording stopped.")

		if(21)
			add_custom_entry( 0, 49, "Recording started.")
			add_custom_entry( 0, 49, "Anna Neso says, '...This is Anna Neso, researcher of Outpost 21. Beginning log 1 of 2570-06-19.'")
			add_custom_entry( 1, 51, "Anna Neso says, '...Something is listening to us. Mimicking us. It hears our words over comms, and spits them back out at us with little rhyme or reason.'")
			add_custom_entry( 2, 18, "Anna Neso says, 'It seems, at least, to understand what a name is... but it fails to be a conversationalist, else-wise.'")
			add_custom_entry( 2, 29, "Anna Neso asks, '...Is it listening to me now, I wonder?'")
			add_custom_entry( 2, 30, "Recording stopped.")
			add_custom_entry( 2, 31, "Recording started.")
			add_custom_entry( 2, 44, "Recording stopped.")
			add_custom_entry( 2, 45, "Recording started.")
			add_custom_entry( 3, 03, "Anna Neso asks, '...The common channel... seems to be all it has access to, at least?'")
			add_custom_entry( 3, 24, "Anna Neso says, 'I thought it might be Inis, at first. They've been... |unaccounted for|, for some time.'")
			add_custom_entry( 3, 58, "Anna Neso says, 'But... no. The voices this thing spouts at us go all the way back to the revolt. It's been wearing |Salkana's| vocals most prominently.'")
			add_custom_entry( 4, 9, "Anna Neso says, '...'")
			add_custom_entry( 4, 49, "Anna Neso says, '...She's been haunting us a number of different ways for some time, though, so... that's little surprise.'")
			add_custom_entry( 5, 02, "Anna Neso asks, '...Does she hold any anger toward me, I wonder? For failing her as I did?'")
			add_custom_entry( 6, 9, "Anna Neso says, 'I... should have stopped her from doing what she did. I really should've. But I thought... a person of my talents, maybe, would be better off going against the grain with her.'")
			add_custom_entry( 6, 25, "Anna Neso says, '|Stupid.| Idiotic.'")
			add_custom_entry( 13, 36, "Recording stopped.")
			add_custom_entry( 13, 37, "Recording started.")
			add_custom_entry( 14, 13, "Anna Neso says, '...Guh. Can't be undone now, in either case. I... just hope I'll be able to face Nipper again, one day.'")
			add_custom_entry( 14, 16, "Anna Neso says, 'End log.'")
			add_custom_entry( 14, 17, "Recording stopped.")
