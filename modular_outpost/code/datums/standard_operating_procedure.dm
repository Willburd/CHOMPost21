...
/datum/sop_entry/authequip
	...
	body = 	"<b>Authorized Equipment:</b>\
			...
			<br/>Officers are required to have the following items on them at all times: A helmet, either worn or in their backpack. An armored vest worn on their chest. Backpack, satchel, or duffel bag worn on their back. A security belt on their waist. Jackboots or other authorized footwear worn. Black combat gloves worn on the hands. Authorized flash-proof sunglasses of: Black, Gray, Smoke, Navy, Dark red, or Clear in color. A holster worn on their person. A flash and/or pepper spray in the pocket. A stun baton kept in either a holster or in the belt. A taser either holstered or kept in the belt. Up to 2 pairs of handcuffs, kept in the belt. Up to 1 spare power cell OR magazine kept in the belt. A mag-light kept in the belt. A body camera worn on the uniform, and enabled at all times when on patrol. \
