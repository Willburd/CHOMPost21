...
/datum/sop_entry/weather
	...
	body = {"<center><b>Weather</center></b>
			<br/>There are many hazards in a world undergoing the E-Shui terraforming process, crew are expected to be aware of these hazards and act accordingly to their station and common sense.
			<br/>Outside the station, the planet's weather contains an acidic enzymatic rainfall, this is an intentional product of the Terraformer that reacts with the native ground soil to produce a thick atmosphere of Nitrogen and Oxygen, and force the climate to begin altering. It is also incredibly hostile to station organic life, and will cause massive acid burns and melted limbs. In foggy conditions, the acidic vapors remain in the air in a smaller concentration, which can cause severe lung damage when inhaled, and severe eye damage with prolonged exposure.
			<br/>Crew going outside must prepare accordingly. Umbrellas to protect from rain and hail. Masks, goggles, and internal air supplies are highly recommended incase weather changes.
			<br/>Underground has a runoff river from the Terraformer's waste products and condensation. This river is even more hazardous than the rain and can dissolve limbs in minutes. Crew must beware of any waterways, puddles, and rapids within the river.<hr/>
			<br/>Crew are not to swim in the river.<br/>Crew are not to drink water from the river.<br/>
			<br/>Crew are not to play in puddles outside.<br/>Crew are not to collect rainwater, except for research, quality control, and terraformer health analysis.<br/>Crew are not to play along river banks.<br/>Crew are not to go rafting in river rapids.<br/>Crew are not to go diving or snorkling in the river.<br/>Crew are not to go fishing in the river.<br/>Crew are not to go water-skiing in the river.<br/>Crew are not to go 'lazy river tubing' in the river.<br/>Crew are allowed to use boats carefully when in the river.<br/>
			<hr/>
			<center><b>Terraformer</center></b>
			<br/>The Terraformer is an incredibly hazardous location, and is off-limits to most personnel. Only trained engineering staff, security, trained medical paramedics, and heads of command with intent, are allowed entry into the terraformer due to the sheer hostility against life that is present in the location. Many surfaces are acidic, the ground is unstable, and muscle contractions may crush crewmembers.<hr/>
			<br/>It must be remembered that the terraformer is a hazardous environment with lots of dangerous air mixtures, to include the lack of air. Internals are required when entering the terraformer, as are self-held light sources, and trail markers of crew member choice. Flags or light beacons are the best.
			<hr/>
...
/datum/sop_entry/rights
	...
	body = {"Definitions: <br/>
			...
			<br>1. A crew member cannot have their bags, pockets, or work area, searched without just cause or an issued warrant. Warrants may only be issued by the Warden, Head of Security, Head of Personnel, the Captain, or Central Command.
			<br>2. A department may not be searched by security without just cause, or warrant.
			<br>3. Security are not authorized to "camera-lurk", or stalk crew members waiting for any slip-up.
			...
			<br>1. Security is required to wear red and black, or red and blue clothing.
			...
			<center><b>Contractual Review. As signed by all E-Shui personnel on \[OUTPOST-21\]:</center></b>
...
/datum/sop_entry/buildcode
	...
	body = 	{"<center><large><b>E-Shui Building Code.</center></large></b>
			...
			<br><hr>
			<center><b>General Guidelines:</center></b>
			<br>Every room is required to have:
			<br>- One fire extinguisher, tested semi-annually.
			<br>- One fire alarm, mounted on a wall 3'-4' off the ground, tested annually.
			...
			<br>- One air alarm, mounted on a wall 4' from the ground, tested monthly with temperatures to range between 15C and 32C except in freezers, which must be within -10C and 0C.
			...
			<br>- One intercom, mounted on a wall 3-5' off the ground. Multiple intercoms in a room must be stacked vertically on the same section of wall space, unless the count would exceed 3 intercoms, in which following intercoms must be place directly horizontally, repeating in sets of 3.
			<br>- One APC, wall mounted 3 1/2' - 4' off the ground. Connected directly to appropriate power cables. Fuses and breakers must be tested every other month.
			...
			<br>- Emergency shutters over every window and doorway to ensure proper sealing of the room in event of a gas leak, fire, or environmental failure. Shutters must be connected to the room's air alarm via wired or wireless connections, and tested monthly.
			...
			<br>- One geiger counter, mounted 4'-6' off the ground.
			<br>- One AI display, mounted at 4'-5' off the ground.
			<br>- One Station Status Display, mounted at 4'5' off the ground.
			...
			<br>Wall mounted power cell chargers must be installed 3'-4' off the ground, with up to 3 per wall section. Desk-based chargers must be securely attached to the table, with up to two chargers per table. Internal breakers must be tested monthly.
			<br><hr>
			...
			<br>
			<br>Disposal pipes are not to cross under walls, and must be constructed of 3' diameter steel. The station's disposal network is to make one continuous loop from and to cargo. A package sorting diversion junction must be located directly after the cargo outlet for appropriate sorting prior to waste transitioning to the incinerator, and an E-Shui proprietary Autosleeving Body Diversion Junction located prior to the cargo waste and mail sorting area. Direct to incinerator lines are not to link with the primary disposal loop until after the package sorting diversion junction, when directly destined for the incinerator.
			...
			<br><hr>
			<br>In any situation where a: Wire, disposal pipe, atmospheric pipe, or any other station infrastructure must pass under a wall in order to achieve effectiveness, that section of wall must have a steel maintenance panel installed in its stead. The maintenance panel must be dual sided, of at least grade 4 construction, and airtight. Maintenance panels are to be between 2' and 4' at their shortest and longest horizontal directions.
			<br>These maintenance panels must also be installed in lieu of maintenance access doors in bathrooms, and any room with more than 1 maintenance access doorway, with hallways exempt.
			<br>For floor markings: Maintenance panels are counted as a wall, and do not require special markings or a lack of marking to indicate a doorway, as they are not intended for standard or regular crew access.
			<br><hr>
			<center><b>Medstations:</center></b>
			<br>Medical emergency treatment rooms located throughout the station must be equipped with at minimum: 2 lights, one body scanner, one backup kiosk, and appropriate table space for medicine storage and stocked with multiple roller beds for safe transport. Each medical treatment area must be appropriately signed and may not be configured for night lighting, and lights must be on at all times during station hours.
			<br>All med stations must be publicly accessible, even when located inside of departments. All medical stations must be floor marked and signed as a medical area for ease of location.
			<br><hr>
...
/datum/sop_entry/hireprom
	...
	author = "E-Shui Official"
	body = 	{"<center><b>Promotion/Hiring Requirements</b></center>
			...
			<br><b>Nurse:</b> You must have a valid, and accurate, license for medical practice. An on-going workstudy is a valid replacement for this requirement in Nurse positions.
			<br>
			...
			<br><b>Scientist:</b>
			<br>
			<br>You must have training in Hazardous Materials, and OPSEC level training 2. As of Dec 12, 2568: You must pass a psychological evaluation. You must have technical compitency in standard mining tools for xenoarcheology.
...
/datum/sop_entry/xenoarch
	...
	body = {"<center><b>E-Shui Xenoarcheological Studies and Research Field Guide</b>
			...
			<br>Allows for visualization of artifacts, which often appear as large brown deposits with white streaks through them.
			<br>
			<br>Hand Equipment - Pickaxe
			<br>Allows for reaching artifact deposit sites.
			<br>
			<br><b>Specialty / Critical Equipment:</b>
			<br>
			<br>Alden-Saraspova Counter (ASC)
			<br>Allows for pinpointing the site of artifacts.
			...
			<br>Allows for scanning artifact deposits to learn the artifact type and depth.
			<br>
			<br>USAGE:
			...
			<br>Coords: Where the anomaly deposit was at when scanned.
			...
			<br>(This large artifact is sealed from the outside world until excavated, in which it may activate.)
			<br>
			<br>Excavation Pick Set & Hand Pickaxe
			<br>Allows for carefully excavating artifacts.
			...
			<br>Hand Pickaxe: 30 mm
			<br>
			<br><b>Supplementary Equipment:</b>
			<br>Xenoarcheology Multitool
			<br>Works as the Alden-Saraspova counter, Depth Analysis Scanner, and Measuring Tape all in one tool.
			<br>
			<br>Excavation Drill
			<br>Replaces the Excavation Pick Set & Hand Pickaxe. Can dig from 1 to 60 mm in one go.
			<br>
			<br>Measuring Tape
			<br>Allows seeing how far your current excavation is.
			<br>
			<br>Core Sampler
			<br>Useless. Do not bother with it.
			<br>
			<br>Locator Device + Tracking Beacon
			<br>Tracking beacon can be set to a frequency, placed on a table, and the Locator can then be set to the same frequency. Tell the locator to 'search' for the device and place it down some ways away from the tracking beacon and they will pair, allowing the tracking beacon to be located at all times.
			<br>NOTES:
			<br>Do not place the tracking beacon and locator too close while searching, otherwise they will be incapable of linking.
			<br>The tracking beacon allows individuals to teleport to the beacon via the station's many teleporters.
			<br>
			<br>GPS
			<br>Make sure to activate it and give it a unique identifier, such as your name.
			<br>
			<br>Excavation Suit + Excavation Hood
			<br>A pressure sealed suit for excavating in locations that lack or have a hostile atmosphere. Lined with asbestos and lead, rendering it radiation immune.
			<br>
			<br>Anomaly Hood + Anomaly Suit + Latex Gloves + goggles
			<br>Allows for examining and interacting with anomalies, lowering the chance of negative effects.
			<br>NOTE: Does not block EMPs emitted from artifacts.
			<br>NOTE: A properly fitted gasmask and internals are suggested for crew that need to breathe.
			<br>
			<br>Suspension Field Generator
			<br>Can be pulled along and wrenched down. Upon turning on, will place whatever entity is directly in front of it in stasis. Recommended for extremely skilled archeologists only.
			<br>
			<br>Sample Container
			<br>Allows storing small artifacts found in an orderly fashion.
			<br>
			<br>Anomaly Container
			<br>Allows safe storage and transport of an anomaly. These are large cases held in a secondary storage room.
			<br>This lead lined container will hold an artifact inside, indefinitely preventing its effects.
			<br>
			<br><hr><center><b>Machinery</b></center>
			<br>Anomaly Analyzer
			<br>When next to an Anomaly Scanner Pad, can be used to analyze an anomaly on the Scanner Pad. This will give triggering factors and information as to the effects of the anomaly. More detail will be listed in the 'Artifact Identification' and 'Artifact Activation' sections of this document.
			<br>
...
/datum/sop_entry/fragords
	...
	author = "E-Shui Central Command Ops"
	body = {"<center><b>The following are adjustments to SoP that may be temporary and revoked at any time:</center></b>
		<br>
		<hr>
		<br>
		<b>Adjustment to Standard Operating Procedure for Authorized Equipment and Usage of Force:</b>
		<br>
		<br>
		Following response time failures and elevated shadekin activity with counter-phase weaponry awaiting SolGov approval:
		<br>
		Security team personnel on teams of less than 6 security individuals, or with a total crew of less than 10, or more than 25, are authorized to possess 1 red or blue armory weapon of choice and ammunition up to 1 magazine at all times, and are authorized to respond to any blue-level or higher threat with all force necessary immediately without elevating station code, if movement to elevate code would allow a threat to escape or retaliate against the station. Lethal ammunition and weapons are not to be used on crew that are not acting or declared as a red-level threat.
		<br>
		...
		<br>
		Further, individuals with lethal weaponry with no security on staff may only be charged with an Infraction, instead of Felony, as long as the weapon was not utilized against station crew.
		<br>
...
/datum/sop_entry/esic_exam
	title = "The E-Shui Standard Internal Confinement (ESIC) Exam"
	author = "E-Shui Official"
	body = {"This exam is to certify individuals aboard E-Shui stations with a standardized methodology of Internal Confinement also known as 'Belly Brigging', and internal paramedic retrieval also known as "healbelly." To ensure the safety of, and to prevent abuse to, prisoners and patients.
			<br/>
			<br/><b>Necessary materials:</b>
			<br/>1 Time keeping device
			<br/>1 Sleevemate or kiosk linked to the station's database
			<br/>1 Method of tracking score, in the case of a singular Examiner/grader, this must be digestion-proof.
			<br/>
			<br/>The exam will partake of an Officer, Paramedic, or other individual seeking certification (Referred to as the Tester), an Examiner, and a Grader. The Examiner and Grader may be the same individual.
			<br/>The exam may take place with an officer or medic on-duty, but may not interfere with normal station duties and protection, ensure additional crew can fill in the gap in coverage during the officer or medical professional being examined.
			<br/>Only a head of staff, Warden, or an individual with at least a Grade 4 ESIC Certification is authorized to be a Grader for the ESIC or ESIC-E exams.
			<br/>Only one 'orifice' may be tested at a time. An orifice is defined as 'any unique area by which prey enter and will be confined within the tester.' Organs that are multi-chambered, but accessed via the same route, such as ruminant stomachs or crops, are counted as one test and one certification. However, should a multi-chambered orifice contain an area where any prey is unrecoverable; prey entering that area will be counted as receiving injury, ending the test.
			<br/>Any: medications, implants, devices, tools, collars, apparel, agreements, bribes, or any other method to enhance or hamper the Tester's containment ability is strictly forbidden. Discovery of any such method will immediately invalidate the test, and may result in punitive action upon the discovered guilty parties.
			<br/>The Examiner must be given a mind scan prior to consumption, and a body scan if they did not have one within the past week. Any requests from the Examiner to be scanned during or after the test must be complied with.
			<br/>
			<br/>The appropriately earned ESIC Internal Confinement Broach is authorized to be worn on any E-Shui service uniform.
			<br/>Synthetic units are authorized to have a magnetic or adhesive sticker, or painted version of their equivalent grade broach located on their chassis adjacent to their identification plate no closer than 1/16 inch, and no further than 1/4 inch from the identification plate.
			<br/>Any individual wearing an ESIC broach without appropriate certification in their employment records will be charged with an infraction of forgery as a minimum sentence.
			<br/>
			<hr>
			<br/><center><b>PROCEDURE</b></center>
			<hr>
			<br/>The Examiner will be consumed by the Tester, whole, and without clothing, although they may be handcuffed to better simulate a prisoner being detained.
			<br/>The test will begin once the Examiner has arrived in the primary holding area of the orifice being tested by the Examiner, and will end upon the Examiner receiving any injury. The Tester must contain the Examiner safely within themselves, and every half-hour, they will be awarded with a new grade. Grade 1 for half an hour, grade 2 for an hour, etc.
			<br/>The Examiner is not to struggle, fight, or otherwise attempt escape or provoke the Tester's insides during the test.
			<br/>The Tester, Grader, or any other individual is not to knead, rub, or otherwise encourage the Tester's insides during the test.
			<br/>Should the Tester reach a total of 8 hours, or grade 16, their grade will be instead replaced with 'Indefinite' as this matches the maximum legal allowed length of a crewmember's shift. Per SolGov regulation, this counts as as exceeding the maximum reasonable time any officer will be expected to contain a prisoner within themselves.
			<br/>
			<br/>Synthetic individuals are automatically graded as 'indefinite' due to presumed control of chassis functions. Should the synthetic individual prove to be unable to render any internal space safe for any duration less than 8 hours, all of their grades are to be immediately revoked until they are able to pass the standard Internal Confinement Exam.
			<br/>
			<br/>Test grades are not to be rounded up, and must only reflect the highest grade fully achieved.
			<br/>Individuals that reach any grade of the ESIC exam are authorized to wear the Bronze Broach of Internal Confinement.
			<br/>Individuals that reach grade 5 in any orifice of the ESIC exam are authorized to wear the Silver broach of Internal Confinement. Individuals that reach an Indefinite period in any orifice are authorized the Gold broach.
			<br/>Upon cessation of the test, the Grader must log, and inform the Tester of their highest achieved grade. This grade must be inputted into employment records promptly under the following format:
			<br/>
			<br/><center><b>Certifications:</b></center>
			<br/><b>E-Shui Internal Confinement ((Or ESIC)) - (Orifice): (Grade #)</b>
			<br/>
			<br/><b>Examples:</b>
			<br/>Certifications:
			<br/>E-Shui Internal Confinement - Stomach: Grade 4
			<br/>E-Shui Internal Confinement - Gelatinous core: Grade 1
			<br/>E-Shui Internal Confinement - Womb: Indefinite.
			<br/>
			<hr>
			<br/>Internal Confinement Enhanced Exam
			<hr>
			<br/>
			<br/>The E-Shui Internal Confinement Enhanced Exam is only authorized to individuals that have achieved at least Grade 3 in the standard ESIC exam, and may not be attempted on any orifice not at least Grade 3 certified.
			<br/>
			<br/>The ESIC-E exam requires the same materials as the ESIC exam, and follows the same definitions unless otherwise declared below.
			<br/>The ESIC-E exam requires the Examiner and Grader be two different individuals, and may have other participants.
			<br/>Synthetic individuals are NOT automatically granted any ESIC-E grades.
			<br/>
			<br/><b>Procedure:</b>
			<hr>
			<br/>The Examiner will be consumed by the Tester, whole, with or without clothing or restraints.
			<br/>The test will begin once the Examiner has arrived in the primary holding area of the orifice being tested, and will end upon the Examiner receiving any injury, or escaping from confinement. The Tester must contain the Examiner safely within themselves, and every half-hour, they will be awarded with a new grade. Grade 1 for half an hour, grade 2 for an hour, etc.
			<br/>
			<br/>The Examiner is required to struggle, squirm, and otherwise attempt escape from within the predator to the best of their ability.
			<br/>The Tester is allowed to knead, rub, or otherwise encourage their insides, or hamper the Examiner's escape attempts, during the test.
			<br/>The Grader is required to knead, rub, or otherwise encourage the Tester's insides during the test.
			<br/>Additional individuals may be allowed to assist the Grader, discussed and agreed upon before the test.
			<br/>
			<br/>Should the Tester reach a total of 8 hours, or grade 16, their grade will be instead replaced with 'Indefinite' as this matches the maximum legal allowed length of a crewmember's shift. Per SolGov regulation, this counts as as exceeding the maximum reasonable time any officer will be expected to contain a prisoner within themselves.
			<br/>
			<br/>Test grades are not to be rounded up, and must only reflect the highest grade achieved.
			<br/>Individuals that reach any grade of the ESIC-E exam are authorized to wear the Ruby Broach of Internal Confinement. Upon reaching grade 5, they are authorized Sapphire broach.
			<br/>Individuals that reach an 'Indefinite' grade of the ESIC-E exam are authorized to wear the Emerald Broach of Internal Confinement.
			<br/>Upon cessation of the test, the Grader must log, and inform the Tester of their highest achieved grade. This grade must be inputted into employment records promptly under the following format:
			<br/>
			<hr>
			<br/><b>E-Shui Internal Confinement Enhanced ((Or ESIC-E)) - (Orifice): (Grade #)</b>
			<br/>Examples:
			<br/>Certifications:
			<br/>ESIC-E - Stomach: Grade 2
			<br/>ESIC-E - Sack: Grade 1"}
