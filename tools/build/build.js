...
export const DmMapsIncludeTarget = new Juke.Target({
  executes: async () => {
    const folders = [
      ...
      ...Juke.glob('modular_outpost/maps/outpost21/**/*.dmm'),
      ...Juke.glob('modular_outpost/maps/submap/**/*.dmm'),
    ];
    const content =
      folders
...
export const DmTarget = new Juke.Target({
  ...
  inputs: [
    ...
    'modular_chomp/code/**',
    'modular_chomp/icons/**',
    'modular_outpost/code/**',
    'modular_outpost/icons/**',
    'sound/**',
    'modular_outpost/maps/**/*.dm',
    'modular_outpost/maps/outpost21/**/*.dmm', // Placed here so it recompiles on map changes
    'modular_outpost/maps/submap/**/*.dmm', // Placed here so it recompiles on map changes
    `${DME_NAME}.dme`,
    NamedVersionFile,
  ],
  outputs: ({ get }) => {
