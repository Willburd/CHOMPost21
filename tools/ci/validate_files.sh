...
if command -v rg >/dev/null 2>&1; then
	...
	map_files="maps/**/**.dmm"
	modular_map_files="modular_outpost/maps/**/**.dmm" # Outpost 21 edit - Modular maps
	...
	modular_map_files="-r --include=modular_outpost/maps/**/**.dmm" # Outpost 21 edit - Modular maps
