...
def main(repo : pygit2.Repository):
    ...
    try:
        repo.remotes.create("upstream", "https://github.com/Willburd/CHOMPost21.git") # Outpost 21 edit
    except ValueError:
        pass
    else:
    ...
    if repo.remotes["upstream"].url != "https://github.com/Willburd/CHOMPost21.git": # Outpost 21 edit
