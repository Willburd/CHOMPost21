...
/datum/shuttle/ferry/tether_backup/process_longjump(var/area/origin, area/intended_destination)
...
/obj/structure/shuttle/engine/proc/repair_welder(var/mob/user, obj/item/weldingtool/WT)
	if(!istype(WT))
		return 0
	if(wear <= 20)
