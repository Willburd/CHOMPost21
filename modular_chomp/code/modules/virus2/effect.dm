...
/datum/disease2/effect/cat/activate(var/mob/living/carbon/mob,multiplier)
...
/datum/disease2/effect/jellylegs/activate(var/mob/living/carbon/mob,multiplier)
...
/datum/disease2/effect/morgellon/activate(var/mob/living/carbon/mob,multiplier)
	if(prob(65))
