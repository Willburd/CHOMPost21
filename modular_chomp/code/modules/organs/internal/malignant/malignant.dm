...
/obj/item/organ/internal/malignant/engineered/chemorgan
	...
	var/chemid = null
	var/deg_chance = 0 // Outpost 21 edit(port) - Disable degrading engineered organs
	var/deg_intensity = 1
...
/obj/item/organ/internal/malignant/engineered/chemorgan/tramadol
	...
	//deg_chance = 3 // Outpost 21 edit(port) - Disable degrading engineered organs
	deg_intensity = 2
...
/obj/item/organ/internal/malignant/engineered/chemorgan/dexalin
	...
	// deg_chance = 5 // Outpost 21 edit(port) - Disable degrading engineered organs
	deg_intensity = 1
...
/obj/item/organ/internal/malignant/engineered/chemorgan/bliss
	...
	deg_chance = 2 // Outpost 21 edit(port) - Disable degrading engineered organs
	deg_intensity = 3
	side_effect_multiplier = 2
