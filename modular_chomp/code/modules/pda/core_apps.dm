...
/datum/data/pda/app/timeclock/proc/getOpenOnDutyJobs(var/mob/user, department)
...
/datum/data/pda/app/timeclock/proc/isOpenOnDutyJob(var/mob/user, var/department, datum/job/job)
	return job \
...
/datum/data/pda/app/timeclock/proc/makeOnDuty(mob/user, var/newrank, newassignment)
