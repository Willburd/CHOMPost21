...
/decl/chemical_reaction/instant/freshtea/green
	...
	required_reagents = list (REAGENT_ID_TEALEAVESGREEN = 1, REAGENT_ID_WATER = 9) // Outpost 21 edit - use water instead of hotwater, that's not even a reagent
	result_amount = 10
...
/decl/chemical_reaction/instant/matcha
	...
	required_reagents = list (REAGENT_ID_MATCHAPOWDER = 1, REAGENT_ID_WATER = 2) // Outpost 21 edit - use water instead of hotwater, that's not even a reagent
	result_amount = 2
