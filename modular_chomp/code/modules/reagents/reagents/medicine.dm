...
/datum/reagent/change_drug/affect_blood(var/mob/living/carbon/human/M, alien, removed)
...
/datum/reagent/cleansingagent/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/purifyingagent/affect_blood(var/mob/living/carbon/M, alien, removed)
	var/chem_effective = 1 * M.species.chem_strength_heal
	if(alien == IS_SLIME)
		chem_effective = 0.66
	if(alien != IS_DIONA)
...
/datum/reagent/burncard/affect_blood(var/mob/living/carbon/M, alien, removed)
	var/chem_effective = 1 * M.species.chem_strength_heal
	if(alien == IS_SLIME)
		chem_effective = 0.75
	if(alien != IS_DIONA)
...
/datum/reagent/burncard/overdose(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/flamecure/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/neotane/affect_blood(var/mob/living/carbon/M, alien, removed)
	var/chem_effective = 1 * M.species.chem_strength_heal
	if(alien == IS_SLIME)
		chem_effective = 0.5
...
/datum/reagent/bloodsealer/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien != IS_DIONA)
...
/datum/reagent/livingagent/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien != IS_DIONA)
		var/chem_effective = 1 * M.species.chem_strength_heal
		if(alien == IS_SLIME)
			chem_effective = 0.5
...
/datum/reagent/performancepeaker/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/souldew/affect_blood(var/mob/living/carbon/M, alien, removed)
	var/chem_effective = 1 * M.species.chem_strength_heal
	if(M.stat == DEAD)
...
/datum/reagent/quadcord
	...
	supply_conversion_value = REFINERYEXPORT_VALUE_HIGHREFINED
	industrial_use = REFINERYEXPORT_REASON_MEDSCI
/datum/reagent/quadcord/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien != IS_DIONA)
		var/chem_effective = 1 * M.species.chem_strength_heal
		if(alien == IS_SLIME)
			chem_effective = 0.5
...
/datum/reagent/curea/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/dryagent/affect_blood(var/mob/living/carbon/M, alien, removed)
	var/chem_effective = 1 * M.species.chem_strength_heal
	if(alien == IS_SLIME)
		chem_effective = 1.25
