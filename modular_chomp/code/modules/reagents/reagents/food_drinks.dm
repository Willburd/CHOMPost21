...
/datum/reagent/drink/tea/dyloteane/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	if(M.ingested)
...
/datum/reagent/drink/tea/dyloteane/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/drink/lowpower/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/highpower/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	if(prob(5))
...
/datum/reagent/ethanol/coffee/jackbrew/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_TAJARA)
		removed *= 1.25
	if(alien == IS_SLIME)
...
/datum/reagent/ethanol/bookwyrm/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/freshtea/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/matcha/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/ethanol/arachnidslammer/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	.=..()
	M.reagents.add_reagent(REAGENT_ID_INFUSEDARACHNIDSLAMMER, removed * 5)
/datum/reagent/ethanol/arachnidslammer/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	.=..()
	M.reagents.add_reagent(REAGENT_ID_INFUSEDARACHNIDSLAMMER, removed * 5)
...
/datum/reagent/infusedarachnidslammer/enragedarachnidslammer/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/ethanol/fetching_fizz/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/ethanol/hearty_punch/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(M.health<=0)
...
/datum/reagent/ethanol/crevice_spike/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/ethanol/mauna_loa/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(prob(10))
