...
/datum/trait/neutral/mobegglaying/apply(var/datum/species/S,mob/living/carbon/human/H)
	..()
...
/datum/trait/neutral/succubus_bite/apply(var/datum/species/S,mob/living/carbon/human/H)
	..()
