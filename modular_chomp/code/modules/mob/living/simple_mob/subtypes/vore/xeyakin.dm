...
/datum/reagent/xeyakinblood/affect_blood(var/mob/living/carbon/M, alien, removed) //should proabaly make something more special but this isn't meant to be a proper chem
