...
var/const/game_version	= "Outpost21"	//Outpost 21 Edit 24/12/19 - Chompers
var/changelog_hash		= ""
...
var/list/robot_module_types = list(
	"Standard", "Engineering", "Surgeon",   "Crisis", //CHOMPedit: Combining Surgeon and Crisis. // Split surgery and crisis borgs again
