...
/datum/announcement/New(var/do_log = 0, var/new_sound = null, do_newscast = 0)
	sound = new_sound
	log = do_log
	newscast = do_newscast

/datum/announcement/priority/New(var/do_log = 1, var/new_sound = 'sound/misc/notice2.ogg', do_newscast = 0)
	..(do_log, new_sound, do_newscast)
	title = "Priority Announcement"
	announcement_type = "Priority Announcement"

/datum/announcement/priority/command/New(var/do_log = 1, var/new_sound = 'sound/misc/notice2.ogg', do_newscast = 0)
	..(do_log, new_sound, do_newscast)
	title = "[command_name()] Update"
	announcement_type = "[command_name()] Update"

/datum/announcement/priority/security/New(var/do_log = 1, var/new_sound = 'sound/misc/notice2.ogg', do_newscast = 0)
	..(do_log, new_sound, do_newscast)
...
/datum/announcement/priority/Message(var/message as text, var/message_title as text, list/zlevels)
...
/datum/announcement/priority/command/Message(var/message as text, var/message_title as text, list/zlevels)
...
/datum/announcement/priority/security/Message(var/message as text, var/message_title as text, list/zlevels)
	GLOB.global_announcer.autosay(span_alert("[message_title]:") + " [message]", ANNOUNCER_NAME, channel = "Common", zlevels = zlevels)

/datum/announcement/proc/NewsCast(var/message as text, message_title as text)
	if(!newscast)
		return
...
/datum/announcement/proc/PlaySound(var/message_sound, list/zlevels)
...
/datum/announcement/proc/internal_postfire_play_sound(var/message_sound, list/zlevels)
...
/datum/announcement/proc/Sound(var/message_sound, list/zlevels)
...
/proc/AnnounceArrival(var/mob/living/carbon/human/character, var/rank, var/join_message, var/channel = "Common", zlevel)
...
/proc/AnnounceArrivalSimple(var/name, var/rank = "visitor", var/join_message = "will arrive at the station shortly", var/channel = "Common", list/zlevels)
