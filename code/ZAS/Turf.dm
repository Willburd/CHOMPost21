...
/turf/return_air()
	...
	GM.adjust_multi(GAS_O2, oxygen, GAS_CO2, carbon_dioxide, GAS_N2, nitrogen, GAS_PHORON, phoron, GAS_N2O, nitrous_oxide, GAS_METHANE, methane) // Outpost 21 edit - Methane, n2o values as well
...
/turf/remove_air(amount as num)
	...
	if(sum>0)
		...
		GM.gas[GAS_METHANE] = (methane/sum)*amount // Outpost 21 edit - Methane
...
/turf/proc/make_air()
	...
	air.adjust_multi(GAS_O2, oxygen, GAS_CO2, carbon_dioxide, GAS_N2, nitrogen, GAS_PHORON, phoron, GAS_N2O, nitrous_oxide, GAS_METHANE, methane) // Outpost 21 edit - Allow map set N2O and CH4
