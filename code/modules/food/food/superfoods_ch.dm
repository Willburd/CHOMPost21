...
/obj/structure/thecake/attackby(var/obj/item/W, mob/living/user)
...
/obj/structure/chaoscake/attackby(var/obj/item/W, mob/living/user)
	if(istype(W,/obj/item/material/knife))
		if(edible == 1)
			HasSliceMissing()
			if(slices <= 0)
...
/obj/structure/theonepizza/attackby(var/obj/item/W, mob/living/user)
	if(istype(W,/obj/item/material/knife))
