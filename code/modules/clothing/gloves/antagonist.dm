...
/obj/item/clothing/gloves/sterile/thieves/proc/pickpocket(var/mob/living/carbon/human/user, var/mob/living/carbon/human/target, proximity)
...
/obj/item/clothing/gloves/sterile/thieves/Touch(var/atom/A, proximity)
