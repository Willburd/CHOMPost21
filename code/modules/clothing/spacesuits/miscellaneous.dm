...
/obj/item/clothing/suit/space/pirate //Whhhhyyyyyyy???
	...
	allowed = list(/obj/item/gun,/obj/item/ammo_magazine,/obj/item/ammo_casing,/obj/item/melee/baton,/obj/item/handcuffs,/obj/item/tank/emergency/oxygen,/obj/item/tank/emergency/nitrogen,/obj/item/tank/emergency/phoron,/obj/item/tank/emergency/carbon_dioxide,/obj/item/tank/emergency/methane)
	slowdown = 0
	armor = list(melee = 60, bullet = 50, laser = 30,energy = 15, bomb = 30, bio = 30, rad = 30)
	siemens_coefficient = 0.9
