...
/obj/item/clothing/accessory/armor/on_attached(var/obj/item/clothing/S, mob/user)
	if(ishuman(user))
...
/obj/item/clothing/accessory/armor/armorplate/ablative/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, attack_text = "the attack")
