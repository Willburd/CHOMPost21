...
/obj/item/clothing/accessory/holster/machete/rapier/holster(var/obj/item/I, mob/living/user)
	..()
	occupied()
	if(has_suit)
		has_suit.update_clothing_icon()

/obj/item/clothing/accessory/holster/machete/rapier/unholster(var/obj/item/I, mob/living/user)
	..()
	occupied()
	if(has_suit)
		has_suit.update_clothing_icon()
