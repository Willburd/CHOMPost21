...
/obj/item/clothing/suit/bio_suit
	...
	slowdown = 1.0
	allowed = list(/obj/item/tank/emergency/oxygen,/obj/item/tank/emergency/nitrogen,/obj/item/tank/emergency/phoron,/obj/item/tank/emergency/carbon_dioxide,/obj/item/tank/emergency/methane,/obj/item/pen,/obj/item/flashlight/pen)
	armor = list(melee = 0, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 100, rad = 20)
