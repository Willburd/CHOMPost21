...
/obj/vehicle/train/RunOver(var/mob/living/M)
	if(pulledby == M) // VOREstation edit: Don't destroy people pulling vehicles up stairs, Also why is this base train vehicle proc in the cargo train file? I spent hours running in circles for this - Willbird
		return
...
/obj/vehicle/train/engine/latch(obj/vehicle/train/T, mob/user)
	...
	if(istype(T, /obj/vehicle/train/trolley) || istype(T, /obj/vehicle/train/trolley_tank)) // Outpost 21 edit - trolly tank support
