...
/obj/item/vehicle_assembly/quadbike/attackby(var/obj/item/W as obj, mob/user as mob)
	..()
...
/obj/item/vehicle_assembly/quadtrailer/attackby(var/obj/item/W as obj, mob/user as mob)
	..()
...
/obj/item/vehicle_assembly/spacebike/attackby(var/obj/item/W as obj, mob/user as mob)
	switch(build_stage)
		if(0)
...
/obj/item/vehicle_assembly/snowmobile/attackby(var/obj/item/W as obj, mob/user as mob)
	switch(build_stage)
		if(0)
			if(istype(W, /obj/item/stack/material/steel))
				var/obj/item/stack/material/steel/S = W
