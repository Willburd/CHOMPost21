...
/spell/aoe_turf/conjure/floor/conjure_animation(var/atom/movable/overlay/animation, turf/target)
...
/spell/aoe_turf/conjure/wall/conjure_animation(var/atom/movable/overlay/animation, turf/target)
