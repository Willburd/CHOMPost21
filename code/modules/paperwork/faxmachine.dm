...
/obj/machinery/photocopier/faxmachine/proc/message_admins(var/mob/sender, var/faxname, var/obj/item/sent, reply_type, font_colour="#006100")
 ...
 */
/obj/machinery/photocopier/faxmachine/proc/message_chat_admins(var/mob/sender, var/faxname, var/obj/item/sent, faxid, font_colour="#006100")
 ...
 */
/obj/machinery/photocopier/faxmachine/proc/message_chat_rolerequest(var/font_colour="#006100", var/role_to_ping, var/reason, jobname)
	if(CONFIG_GET(string/chat_webhook_url))
		spawn(0)
