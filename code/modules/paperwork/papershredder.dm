...
/obj/machinery/papershredder/proc/empty_bin(var/mob/living/user, obj/item/storage/empty_into)
...
/obj/item/shreddedp/attackby(var/obj/item/W as obj, mob/user)
	if(istype(W, /obj/item/flame/lighter))
		burnpaper(W, user)
	else
		..()

/obj/item/shreddedp/proc/burnpaper(var/obj/item/flame/lighter/P, mob/user)
	if(user.restrained())
		return
	if(!P.lit)
