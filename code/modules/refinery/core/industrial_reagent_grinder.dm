...
/obj/machinery/reagent_refinery/grinder/attackby(var/obj/item/O as obj, mob/user as mob)
	. = ..()
	if(.)
		return
...
/obj/machinery/reagent_refinery/grinder/handle_transfer(var/atom/origin_machine, var/datum/reagents/RT, var/source_forward_dir, var/transfer_rate, filter_id = "")
