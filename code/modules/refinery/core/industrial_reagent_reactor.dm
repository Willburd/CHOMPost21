...
/obj/machinery/reagent_refinery/reactor/handle_transfer(var/atom/origin_machine, var/datum/reagents/RT, var/source_forward_dir, var/transfer_rate, filter_id = "")
...
/obj/machinery/reagent_refinery/reactor/attackby(var/obj/item/O as obj, mob/user as mob)
	. = ..()
