...
/obj/machinery/reagent_refinery/attackby(var/obj/item/O as obj, mob/user as mob)
...
/obj/machinery/reagent_refinery/proc/transfer_tank( var/datum/reagents/RT, var/obj/machinery/reagent_refinery/target, var/source_forward_dir, filter_id = "")
	PROTECTED_PROC(TRUE)
...
/obj/machinery/reagent_refinery/proc/handle_transfer(var/atom/origin_machine, var/datum/reagents/RT, var/source_forward_dir, var/transfer_rate, filter_id = "") // Handle transfers in an override, instead of one monster function that typechecks like transfer_tank() used to be
...
/obj/machinery/reagent_refinery/proc/tutorial(var/flags,list/examine_list)
	// Specialty
