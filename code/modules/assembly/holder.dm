...
/obj/item/assembly_holder/proc/attach(var/obj/item/assembly/D, var/obj/item/assembly/D2, mob/user)
	if(!D || !D2)
		return FALSE
...
/obj/item/assembly_holder/attackby(var/obj/item/W, mob/user)
...
/obj/item/assembly_holder/proc/process_activation(var/obj/D, normal = 1)
	if(!D)
		return 0
	if(!secured)
