...
/proc/spacevine_infestation(var/potency_min=70, var/potency_max=100, var/maturation_min=5, maturation_max=15)
...
/obj/effect/plant/Initialize(mapload, var/datum/seed/newseed, obj/effect/plant/newparent)
	. = ..()
...
/obj/effect/plant/attackby(var/obj/item/W, mob/user)
