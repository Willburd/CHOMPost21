...
/datum/seed/mushroom
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,25), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/plump
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(2,10), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/hallucinogenic
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), REAGENT_ID_PSILOCYBIN = list(3,5), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/hallucinogenic/strong
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_STOXIN = list(3,3), REAGENT_ID_BLISS = list(1,25), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/poison
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_AMATOXIN = list(3,3), REAGENT_ID_PSILOCYBIN = list(1,25), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/poison/death
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), REAGENT_ID_AMATOXIN = list(13,3), REAGENT_ID_PSILOCYBIN = list(1,25), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/towercap/red
	...
	chems = list(REAGENT_ID_WOODPULP = list(10,1), REAGENT_ID_TANNIN = list(1,10), REAGENT_ID_FUNGI = list(3,6)) // Outpost 21 edit - mushroom allergy
	mutants = null
...
/datum/seed/mushroom/glowshroom
	...
	mutants = null
	chems = list(REAGENT_ID_RADIUM = list(1,20), REAGENT_ID_FUNGI = list(3,26)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/plastic
	...
	mutants = null
	chems = list(REAGENT_ID_PLASTICIDE = list(1,10), REAGENT_ID_FUNGI = list(2,6)) // Outpost 21 edit - mushroom allergy
...
/datum/seed/mushroom/spore
	...
	mutants = null
	chems = list(REAGENT_ID_SEROTROTIUM = list(5,10), REAGENT_ID_MOLD = list(1,10), REAGENT_ID_FUNGI = list(2,11)) // Outpost 21 edit - mushroom allergy
