...
/obj/machinery/computer/xenobio2/attackby(var/obj/item/W, mob/user)
...
/obj/machinery/computer/xenobio2/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, force_open = 1)
	if(!user)
		return
	if(!injector)
		return
