...
/obj/machinery/xenobio/extractor/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, force_open = 1)
	if(!user)
		return
...
/obj/machinery/xenobio/editor/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, force_open = 1)
...
/obj/machinery/xenobio/editor/proc/move_into_editor(var/mob/user,mob/living/victim)
