...
/obj/machinery/xenobio2/manualinjector/proc/move_into_injector(var/mob/user,mob/living/victim)
	if(src.occupant)
...
/obj/machinery/xenobio2/manualinjector/attackby(var/obj/item/W, mob/user)
