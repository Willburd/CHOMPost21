...
/obj/item/integrated_circuit/manipulation/weapon_firing/attackby(var/obj/O, mob/user)
...
/obj/item/integrated_circuit/manipulation/grenade/attackby(var/obj/item/grenade/G, mob/user)
	if(istype(G))
		if(attached_grenade)
