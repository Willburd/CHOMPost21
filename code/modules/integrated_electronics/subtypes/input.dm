...
/obj/item/integrated_circuit/input/receive_exonet_message(var/atom/origin_atom, var/origin_address, var/message, text)
...
/obj/item/integrated_circuit/input/microphone/sign
	...
	var/list/readable_langs = list(
		...
		LANGUAGE_SOL_COMMON,
		LANGUAGE_TRADEBAND,
		// LANGUAGE_GUTTER, // Outpost 21 edit - Not for borgs
		LANGUAGE_TERMINUS,
		LANGUAGE_SIGN
		)
