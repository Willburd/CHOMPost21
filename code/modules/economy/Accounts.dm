...
/proc/create_account(new_owner_name = "Default user", starting_funds = 0, obj/machinery/account_database/source_db, offmap = FALSE)
	...
	if(!source_db)
		...
		T.date = "[num2text(rand(1,28))] [pick("January","February","March","April","May","June","July","August","September","October","November","December")], [CURRENT_STATION_YEAR - rand(3,8)]" // Outpost 21 edit(port) - use actual station year
