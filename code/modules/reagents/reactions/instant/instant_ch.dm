...
/datum/decl/chemical_reaction/instant/xenolazarus/on_reaction(var/datum/reagents/holder, created_volume) //literally all this does is mash the regenerate button
