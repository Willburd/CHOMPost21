...
/datum/decl/chemical_reaction/instant/solidification/on_reaction(var/datum/reagents/holder, created_volume)
...
/datum/decl/chemical_reaction/instant/plastication/on_reaction(var/datum/reagents/holder, created_volume)
	var/sheets = FLOOR(created_volume,1)
	if(sheets)
...
/datum/decl/chemical_reaction/instant/soapification/on_reaction(var/datum/reagents/holder, created_volume)
...
/datum/decl/chemical_reaction/instant/carpetify/on_reaction(var/datum/reagents/holder, created_volume)
	var/sheets = FLOOR(created_volume,1)
	if(sheets)
...
/datum/decl/chemical_reaction/instant/concrete/on_reaction(var/datum/reagents/holder, created_volume)
	var/sheets = FLOOR(created_volume,1)
	if(sheets)
...
/datum/decl/chemical_reaction/instant/explosion_potassium/on_reaction(var/datum/reagents/holder, created_volume)
...
/datum/decl/chemical_reaction/instant/flash_powder/on_reaction(var/datum/reagents/holder, created_volume)
...
/datum/decl/chemical_reaction/instant/emp_pulse/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
...
/datum/decl/chemical_reaction/instant/nitroglycerin/on_reaction(var/datum/reagents/holder, created_volume)
	var/datum/effect/effect/system/reagents_explosion/e = new()
...
/datum/decl/chemical_reaction/instant/napalm/on_reaction(var/datum/reagents/holder, created_volume)
...
/datum/decl/chemical_reaction/instant/chemsmoke/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
...
/datum/decl/chemical_reaction/instant/foam/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
...
/datum/decl/chemical_reaction/instant/metalfoam/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
...
/datum/decl/chemical_reaction/instant/ironfoam/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
