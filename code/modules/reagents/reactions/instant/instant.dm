...
/decl/chemical_reaction/instant/sodiumchloride
	...
	inhibitors = list(REAGENT_ID_COPPER = 1) // Outpost 21 edit - titanium dioxide refinement uses a similar formula
	result_amount = 2
...
/decl/chemical_reaction/instant/lexorin
	...
	inhibitors = list(REAGENT_ID_COPPER = 1) // Outpost 21 edit - messes with hemocyanin
	result_amount = 3
...
/decl/chemical_reaction/instant/hydrophoron
	...
	inhibitors = list(REAGENT_ID_NITROGEN = 1,REAGENT_ID_COPPER = 1) //So it doesn't mess with lexorin, Outpost 21 edit - and hemocyanin
	result_amount = 2
