...
/datum/decl/chemical_reaction/instant/food/tofu/on_reaction(var/datum/reagents/holder, created_volume)
...
/datum/decl/chemical_reaction/instant/food/chocolate_bar/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/decl/chemical_reaction/instant/food/chocolate_bar2/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
		new /obj/item/reagent_containers/food/snacks/chocolatebar(location)
	return
...
/datum/decl/chemical_reaction/instant/food/cheesewheel/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/decl/chemical_reaction/instant/food/meatball/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/decl/chemical_reaction/instant/food/dough/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/decl/chemical_reaction/instant/food/syntiflesh/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/decl/chemical_reaction/instant/food/butter/on_reaction(var/datum/reagents/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
