...
/datum/reagent/macrocillin/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/microcillin/affect_blood(var/mob/living/carbon/M, alien, removed)
	var/new_size = clamp((M.size_multiplier - 0.01), RESIZE_MINIMUM_DORMS, RESIZE_MAXIMUM_DORMS)
...
/datum/reagent/normalcillin/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/sizeoxadone/affect_blood(var/mob/living/carbon/M, alien, removed)
	M.make_dizzy(1)
...
/datum/reagent/ickypak/affect_blood(var/mob/living/carbon/M, alien, removed)
	M.make_dizzy(1)
	M.adjustHalLoss(2)
...
/datum/reagent/unsorbitol/affect_blood(var/mob/living/carbon/M, alien, removed)
	M.make_dizzy(1)
	M.adjustHalLoss(1)
...
/datum/reagent/androrovir/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/gynorovir/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(!(M.allow_spontaneous_tf))
		return
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/androgynorovir/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(!(M.allow_spontaneous_tf))
		return
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
...
/datum/reagent/paralysis_toxin/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/pain_enzyme/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/aphrodisiac/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(!M)	return
