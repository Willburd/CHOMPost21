...
/datum/reagent/adranol/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	if(M.confused)
		M.Confuse(-8*removed)
...
/datum/reagent/numbing_enzyme/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/numbing_enzyme/overdose(var/mob/living/carbon/M, alien)
...
/datum/reagent/vermicetol/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/sleevingcure/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/prussian_blue/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/lipozilase/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/lipostipo/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	M.adjust_nutrition(-20 * removed)
	if(M.weight < 500)
		M.weight += 0.3
...
/datum/reagent/polymorph/affect_blood(var/mob/living/carbon/target, removed)
...
/datum/reagent/glamour/affect_blood(var/mob/living/carbon/target, removed)
