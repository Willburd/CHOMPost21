...
/datum/reagent/claridyl/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien != IS_DIONA)
...
/datum/reagent/claridyl/bloodburn/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(M.bloodstr)//No seriously dont inject this wtf is wrong with you.
		for(var/datum/reagent/R in M.bloodstr.reagent_list)
			if(istype(R, /datum/reagent/blood))
				R.remove_self(removed * 15)

/datum/reagent/claridyl/bloodburn/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(M.ingested)
...
/datum/reagent/eden/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/eden/snake/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	M.adjustOxyLoss(1)
	M.adjustFireLoss(1)
	M.adjustBruteLoss(1)
	M.adjustToxLoss(1)
...
/datum/reagent/tercozolam/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/hannoa/overdose(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(ishuman(M))
...
/datum/reagent/hannoa/affect_blood(var/mob/living/carbon/M, var/alien, removed) //Sleepy if not overdosing.
	..()
...
/datum/reagent/bullvalene/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_SLIME || alien == IS_DIONA)
		return
...
/datum/reagent/serazine/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/alizene/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	var/chem_effective = 1
	if(alien == IS_SLIME)
		chem_effective = 0.75
	if(alien != IS_DIONA)
