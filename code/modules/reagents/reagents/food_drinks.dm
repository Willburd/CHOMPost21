...
/datum/reagent/nutriment/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/nutriment/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	switch(alien)
		if(IS_DIONA) return
...
/datum/reagent/nutriment/coating/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/nutriment/coating/mix_data(var/newdata, newamount)
	if (!data)
		data = list()
...
/datum/reagent/nutriment/coating/beerbatter/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
//Handles setting the temperature when oils are mixed
/datum/reagent/nutriment/triglyceride/oil/mix_data(var/newdata, newamount)
...
/datum/reagent/nutriment/triglyceride/oil/affect_touch(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/nutriment/protein/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	switch(alien)
		if(IS_TESHARI)
...
/datum/reagent/nutriment/honey/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/nutriment/durian/touch_mob(var/mob/M, amount)
	..()
...
/datum/reagent/nutriment/durian/touch_turf(var/turf/T, amount)
	..()
	if(istype(T))
...
/datum/reagent/lipozine/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/sodiumchloride/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
		M.adjustFireLoss(removed)

/datum/reagent/sodiumchloride/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/frostoil/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/frostoil/affect_ingest(var/mob/living/carbon/M, var/alien, removed) // Eating frostoil now acts like capsaicin. Wee!
	if(alien == IS_DIONA)
		return
...
/datum/reagent/capsaicin/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(0.5 * removed)

/datum/reagent/capsaicin/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	// Do not call parent, we don't want this absorbed into our bloodstream!
	handle_spicy(M, alien, removed)

/datum/reagent/proc/handle_spicy(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	if(alien == IS_ALRAUNE) // VOREStation Edit: It wouldn't affect plants that much.
		if(prob(5))
...
/datum/reagent/condensedcapsaicin/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(0.5 * removed)

/datum/reagent/condensedcapsaicin/affect_touch(var/mob/living/carbon/M, var/alien, removed)
	var/eyes_covered = 0
	var/mouth_covered = 0
...
/datum/reagent/condensedcapsaicin/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
		if(!H.can_feel_pain())
			return
...
/datum/reagent/drink/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	var/strength_mod = 1
...
/datum/reagent/drink/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/drink/overdose(var/mob/living/carbon/M, alien) //Add special interactions here in the future if desired.
	..()
...
/datum/reagent/drink/juice/carrot/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/juice/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/juice/lime/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(-0.5 * removed)
...
/datum/reagent/drink/juice/orange/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/juice/tomato/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/milk/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.heal_organ_damage(0.5 * removed, 0)
...
/datum/reagent/drink/tea/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(-0.5 * removed)
...
/datum/reagent/drink/tea/icetea/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
...
/datum/reagent/drink/tea/icetea/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= 0.5
...
/datum/reagent/drink/coffee/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
	..()
...
/datum/reagent/drink/coffee/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/coffee/handle_addiction(var/mob/living/carbon/M, alien)
...
/datum/reagent/drink/coffee/icecoffee/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= 0.5
...
/datum/reagent/drink/coffee/icecoffee/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= 0.5
...
/datum/reagent/drink/coffee/soy_latte/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	M.heal_organ_damage(0.5 * removed, 0)
...
/datum/reagent/drink/coffee/cafe_latte/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	M.heal_organ_damage(0.5 * removed, 0)
...
/datum/reagent/drink/milkshake/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/milkshake/coffeeshake/overdose(var/mob/living/carbon/M, alien)
	M.make_jittery(5)
...
/datum/reagent/drink/rewriter/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	M.make_jittery(5)
...
/datum/reagent/drink/soda/nuka_cola/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/doctor_delight/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/hell_ramen/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	handle_spicy(M, alien, removed)
...
/datum/reagent/drink/ice/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
...
/datum/reagent/drink/ice/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= rand(1,3)
...
/datum/reagent/drink/nuclearwaste/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.bloodstr.add_reagent(REAGENT_ID_RADIUM, 0.3)

/datum/reagent/drink/nuclearwaste/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/sodaoil/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/sodaoil/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/drink/syrup/overdose(var/mob/living/carbon/M, alien)
	if(alien == IS_DIONA)
		return
	M.make_dizzy(1)
...
/datum/reagent/ethanol/beer/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/deadrum/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	if(M.species.robo_ethanol_drunk || !(M.isSynthetic()))
...
/datum/reagent/ethanol/coffee/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	if(!(M.isSynthetic()))
		if(alien == IS_DIONA)
			return
		..()
...
/datum/reagent/ethanol/coffee/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	//if(alien == IS_TAJARA)
		//M.adjustToxLoss(2 * removed)
		//M.make_jittery(4)
		//return
...
/datum/reagent/ethanol/thirteenloko/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/vodka/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(!(M.isSynthetic()))
...
/datum/reagent/ethanol/pwine/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/beepsky_smash/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/neurotoxin/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/unathiliquor/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/soemmerfire/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	handle_spicy(M, alien, removed)
...
/datum/reagent/ethanol/voxdelight/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	if(alien == IS_VOX)
...
/datum/reagent/ethanol/slimeshot/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/ethanol/godka/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/ethanol/deathbell/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
...
/datum/reagent/nutriment/magicdust/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	..()
