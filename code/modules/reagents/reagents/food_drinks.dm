...
/datum/reagent/nutriment/coating/affect_ingest(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/nutriment/coating/beerbatter/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/nutriment/triglyceride/oil/affect_touch(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/sodiumchloride/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		M.adjustFireLoss(removed)

/datum/reagent/sodiumchloride/affect_ingest(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/frostoil/affect_ingest(var/mob/living/carbon/M, alien, removed) // Eating frostoil now acts like capsaicin. Wee!
	if(alien == IS_DIONA)
		return
...
/datum/reagent/proc/handle_spicy(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
	if(alien == IS_ALRAUNE) // VOREStation Edit: It wouldn't affect plants that much.
		if(prob(5))
...
/datum/reagent/condensedcapsaicin/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(0.5 * removed)

/datum/reagent/condensedcapsaicin/affect_touch(var/mob/living/carbon/M, alien, removed)
	var/eyes_covered = 0
	var/mouth_covered = 0
...
/datum/reagent/condensedcapsaicin/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
		if(!H.can_feel_pain())
			return
...
/datum/reagent/drink/tea/icetea/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
...
/datum/reagent/drink/tea/icetea/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= 0.5
...
/datum/reagent/drink/coffee/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/coffee/icecoffee/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= 0.5
...
/datum/reagent/drink/coffee/icecoffee/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= 0.5
...
/datum/reagent/drink/milkshake/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/soda/nuka_cola/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/ice/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
...
/datum/reagent/drink/ice/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		if(M.bodytemperature > T0C)
			M.bodytemperature -= rand(1,3)
...
/datum/reagent/drink/nuclearwaste/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.bloodstr.add_reagent(REAGENT_ID_RADIUM, 0.3)

/datum/reagent/drink/nuclearwaste/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/sodaoil/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/sodaoil/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/unathiliquor/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/soemmerfire/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	handle_spicy(M, alien, removed)
...
/datum/reagent/ethanol/voxdelight/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	if(alien == IS_VOX)
...
/datum/reagent/ethanol/slimeshot/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/ethanol/godka/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/deathbell/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/nutriment/magicdust/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
