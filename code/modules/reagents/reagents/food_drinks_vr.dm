...
/datum/reagent/ethanol/burnout/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	// Deathbell effects.
...
/datum/reagent/ethanol/monstertamer/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/monstertamer/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/galacticpanic/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.Stun(2)
...
/datum/reagent/ethanol/russianroulette/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/hairoftherat/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/hairoftherat/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(M.species.organic_food_coeff)
		if(alien == IS_SLIME || alien == IS_CHIMERA) //slimes and chimera can get nutrition from injected nutriment and protein
			M.nutrition += (alt_nutriment_factor * removed)
...
/datum/reagent/nutriment/protein/brainzsnax/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/coffee/nukie/mega/sight/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(prob(1))
		if(ishuman(M))
			var/mob/living/carbon/human/H = M
...
/datum/reagent/drink/coffee/nukie/mega/heart/affect_ingest(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/drink/coffee/nukie/mega/shock/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/coffee/nukie/mega/fast/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(prob(1))
...
/datum/reagent/drink/coffee/nukie/mega/high/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	var/threshold = 1
...
/datum/reagent/drink/coffee/nukie/mega/shrink/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/coffee/nukie/mega/grow/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	var/new_size = clamp((M.size_multiplier + 0.01), RESIZE_MINIMUM_DORMS, RESIZE_MAXIMUM_DORMS)
	M.resize(new_size, uncapped = M.has_large_resize_bounds(), aura_animation = FALSE)
...
/datum/reagent/drink/coffee/nukie/mega/one/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.add_chemical_effect(CE_DARKSIGHT, 1)
	M.add_chemical_effect(CE_SPEEDBOOST, 1)
	M.heal_organ_damage(1.5 * removed, 1.5 * removed)

/datum/reagent/drink/coffee/nukie/mega/one/overdose(var/mob/living/carbon/M, alien, removed)
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
		H.eye_blurry += 20
