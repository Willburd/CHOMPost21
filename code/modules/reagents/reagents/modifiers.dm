...
/datum/reagent/modapplying/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/modapplying/cryofluid/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	..(M, alien, removed)
	M.bodytemperature -= removed * 20

/datum/reagent/modapplying/cryofluid/affect_ingest(var/mob/living/carbon/M, var/alien, removed)
	affect_blood(M, alien, removed * 2.5)

/datum/reagent/modapplying/cryofluid/affect_touch(var/mob/living/carbon/M, var/alien, removed)
	affect_blood(M, alien, removed * 0.6)

/datum/reagent/modapplying/cryofluid/touch_mob(var/mob/M, amount)
	..()
	if(isliving(M))
		var/mob/living/L = M
...
/datum/reagent/modapplying/cryofluid/touch_turf(var/turf/T, amount)
	..()
