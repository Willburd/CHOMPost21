...
/obj/item/reagent_containers/borghypo/proc/try_add_reagent(var/datum/reagents/target_reagents, var/mob/user, var/reagent_id, amount)
...
/obj/item/reagent_containers/borghypo/proc/try_injection(var/datum/reagents/target_reagents, mob/user)
...
/obj/item/reagent_containers/borghypo/Topic(var/href, list/href_list)
...
/obj/item/reagent_containers/borghypo/service/afterattack(var/obj/target, var/mob/user, proximity)
	if(!proximity)
		return
