...
/obj/machinery/injector_maker/attackby(var/obj/item/O, mob/user)
...
/obj/machinery/injector_maker/proc/make_injector(var/size, var/amount, var/new_name, material, mob/user)
	if(!beaker)
		return
