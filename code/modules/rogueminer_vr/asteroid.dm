...
//Builds an empty map
/datum/rogue/asteroid/New(var/core, var/tw, tu)
...
/datum/rogue/asteroid/proc/spot_add(var/x,var/y,thing)
	if(!x || !y || !thing)
		return
...
/datum/rogue/asteroid/proc/spot_remove(var/x,var/y,thing)
	if(!x || !y || !thing)
		return
...
/datum/rogue/asteroid/proc/spot_clear(var/x,y)
	if(!x || !y)
		return
