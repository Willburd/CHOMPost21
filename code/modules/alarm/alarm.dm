...
/datum/alarm/New(var/atom/origin, var/atom/source, var/duration, var/severity, hidden)
	src.origin = origin
...
/datum/alarm/proc/set_source_data(var/atom/source, var/duration, var/severity, hidden)
