...
/obj/machinery/power/smes/buildable/proc/total_system_failure(var/intensity = 0, mob/user)
...
/obj/machinery/power/smes/buildable/proc/apcs_overload(var/failure_chance, overload_chance)
	if (!powernet)
		return
...
/obj/machinery/power/smes/buildable/attackby(var/obj/item/W, mob/user)
