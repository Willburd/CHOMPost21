/datum/gear/accessory/pilot_webbing1
	...
	allowed_roles = list(JOB_SECURITY_OFFICER, /*JOB_DETECTIVE,*/ JOB_HEAD_OF_SECURITY,JOB_WARDEN,JOB_EXPLORER,JOB_PATHFINDER,JOB_BLUESHIELD_GUARD,JOB_PILOT,JOB_SECURITY_PILOT) // Outpost 21 edit - Detective is officer now
