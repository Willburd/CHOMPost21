...
/datum/gear/utility/communicator/New()
	...
	for(var/obj/item/communicator_type as anything in typesof(/obj/item/communicator)/* Outpost 21 edit - Nif removal: - list(/obj/item/device/communicator/integrated,/obj/item/device/communicator/commlink)*/) //VOREStation Edit - Remove Commlink
