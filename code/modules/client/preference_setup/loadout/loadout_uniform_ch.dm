/datum/gear/uniform/job_sec/flightsuit
	...
	allowed_roles = list(JOB_WARDEN, /*JOB_DETECTIVE,*/ JOB_SECURITY_OFFICER,JOB_HEAD_OF_SECURITY,JOB_BLUESHIELD_GUARD,JOB_BRIG_PHYSICIAN) // Outpost 21 edit - Detective is officer now, Brig medic accessible
...
/datum/gear/uniform/job_nullsuit/sec
	...
	allowed_roles = list(JOB_HEAD_OF_SECURITY, JOB_WARDEN, /*JOB_DETECTIVE,*/ JOB_SECURITY_OFFICER,JOB_BLUESHIELD_GUARD,JOB_BRIG_PHYSICIAN) // Outpost 21 edit - Detective is officer now, Brig medic accessible
