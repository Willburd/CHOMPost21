...
/datum/vote/New(var/_initiator, var/_question, list/_choices, _is_custom = FALSE)
...
/datum/vote/proc/calculate_vote_result(var/list/voted, var/list/choices, vote_result_type)
