...
/obj/machinery/artifact/New()
	...
	if(icon_num == 7 || icon_num == 8 || icon_num == 15)
		...
		if(prob(50))
			my_effect.trigger = pick(TRIGGER_ENERGY, TRIGGER_HEAT, TRIGGER_COLD, TRIGGER_PHORON, TRIGGER_OXY, TRIGGER_CO2, TRIGGER_NITRO, TRIGGER_METHANE)
	else if(icon_num == 11)
		...
		if(prob(60))
			my_effect.trigger = pick(TRIGGER_TOUCH, TRIGGER_HEAT, TRIGGER_COLD, TRIGGER_PHORON, TRIGGER_OXY, TRIGGER_CO2, TRIGGER_NITRO, TRIGGER_METHANE)
