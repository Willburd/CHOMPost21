...
/datum/decl/emote/helper/vwag/do_emote(var/mob/living/carbon/human/user, extra_params)
	if(user.toggle_tail(message = 1))
		return ..()

/datum/decl/emote/helper/vwag/get_emote_message_3p(var/mob/living/carbon/human/user, var/atom/target, extra_params)
...
/datum/decl/emote/helper/vflap/do_emote(var/mob/living/carbon/human/user, extra_params)
	if(user.toggle_wing(message = 1))
		return ..()

/datum/decl/emote/helper/vflap/get_emote_message_3p(var/mob/living/carbon/human/user, var/atom/target, extra_params)
