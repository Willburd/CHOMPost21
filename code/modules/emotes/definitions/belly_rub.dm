...
/datum/decl/emote/visible/bellyrub/get_emote_message_1p(var/atom/user, atom/target, extra_params)
...
/datum/decl/emote/visible/bellyrub/get_emote_message_3p(var/atom/user, atom/target, extra_params)
	return
