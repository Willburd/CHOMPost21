...
/datum/decl/emote/audible/pain/get_emote_message_1p(var/atom/user, var/atom/target, extra_params)
	if(ishuman(user))
...
/datum/decl/emote/audible/pain/get_emote_message_3p(var/atom/user, var/atom/target, extra_params)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
