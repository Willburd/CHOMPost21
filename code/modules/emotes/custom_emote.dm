...
/mob/proc/custom_emote(var/m_type = VISIBLE_MESSAGE, var/message, range = world.view, check_stat = TRUE)
...
/mob/proc/automatic_custom_emote(var/m_type = VISIBLE_MESSAGE, var/message, range = world.view, check_stat = FALSE)
...
/mob/proc/process_normal_emote(var/m_type = VISIBLE_MESSAGE, var/message, input, range = world.view)
	var/list/formatted
	var/runemessage
	if(input)
...
/mob/proc/process_automatic_emote(var/m_type = VISIBLE_MESSAGE, var/message, input, range = world.view)
	var/list/formatted
	var/runemessage
	if(input)
		formatted = format_emote(src, message)
