...
/obj/item/projectile/bullet/magnetic/fuelrod/on_hit(var/atom/target, blocked = 0, def_zone = null) //Future-proofing. Special effects for impact.
	if(isliving(target))
...
/obj/item/projectile/bullet/magnetic/fuelrod/supermatter/on_hit(var/atom/target, blocked = 0, def_zone = null) //You cannot touch the supermatter without disentigrating. Assumedly, this is true for condensed rods of it flying at relativistic speeds.
