...
/obj/item/gun/launcher/can_hit(var/mob/living/target as mob, mob/living/user as mob)
	return 1
...
/obj/item/gun/launcher/process_projectile(obj/item/projectile, mob/user, atom/target, var/target_zone, var/params=null, var/pointblank=0, reflex=0)
