...
/obj/item/gun/energy/gun/protector/emag_act(var/remaining_charges,mob/user)
	..()
	if(!emagged)
		emagged = TRUE
...
/obj/item/gun/energy/gun/protector/pilotgun/locked/emag_act(var/remaining_charges,mob/user)
	return ..()
