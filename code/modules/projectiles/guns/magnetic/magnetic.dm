...
/obj/item/gun/magnetic/fuelrod/proc/blitzed(var/turf/T, mob/living/carbon/M, max_range, banglet)					// Added a new proc called 'bang' that takes a location and a person to be banged.
