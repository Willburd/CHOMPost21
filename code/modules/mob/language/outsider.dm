...
/datum/language/ling/broadcast(var/mob/living/speaker,var/message,speaker_mask)
...
/datum/language/corticalborer/broadcast(var/mob/living/speaker,var/message,speaker_mask)
