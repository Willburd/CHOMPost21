...
/mob/proc/combine_message(var/list/message_pieces, var/verb, mob/speaker, always_stars = FALSE, radio = FALSE)
...
/mob/proc/hear_say(var/list/message_pieces, var/verb = "says", var/italics = 0, var/mob/speaker = null, sound/speech_sound, sound_vol)
	if(!client && !teleop)
		return FALSE
...
/mob/living/hear_say(var/list/message_pieces, var/verb = "says", var/italics = 0, var/mob/speaker = null, sound/speech_sound, sound_vol)
	.=..()
...
/mob/proc/hear_radio(var/list/message_pieces, var/verb = "says", var/part_a, var/part_b, var/part_c, var/part_d, var/part_e, var/mob/speaker = null, hard_to_hear = 0, vname = "")
...
/mob/proc/hear_signlang(var/message, var/verb = "gestures", var/verb_understood = "gestures", var/datum/language/language, mob/speaker = null, speech_type = 1)
	if(!client)
		return
