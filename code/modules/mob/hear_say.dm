...
/mob/proc/combine_message(var/list/message_pieces, var/verb, var/mob/speaker, always_stars = FALSE, radio = FALSE)
...
/mob/proc/hear_say(var/list/message_pieces, var/verb = "says", var/italics = 0, var/mob/speaker = null, var/sound/speech_sound, sound_vol)
	if(!client && !teleop)
		return FALSE
...
/mob/living/hear_say(var/list/message_pieces, var/verb = "says", var/italics = 0, var/mob/speaker = null, var/sound/speech_sound, sound_vol)
	.=..()
...
/mob/proc/on_hear_say(var/message, mob/speaker = null)
	if(client)
...
/mob/living/silicon/on_hear_say(var/message, mob/speaker = null)
	if(client)
		message = span_game(span_say(message))
		if(speaker && !speaker.client)
			message = span_npc_say(message)
...
/mob/proc/hear_radio(var/list/message_pieces, var/verb = "says", var/part_a, var/part_b, var/part_c, var/part_d, var/part_e, var/mob/speaker = null, var/hard_to_hear = 0, vname = "")
...
/mob/proc/hear_signlang(var/message, var/verb = "gestures", var/verb_understood = "gestures", var/datum/language/language, var/mob/speaker = null, speech_type = 1)
	if(!client)
		return
...
/mob/proc/hear_holopad_talk(list/message_pieces, var/verb = "says", mob/speaker = null)
	var/list/combined = combine_message(message_pieces, verb, speaker)
	var/message = combined["formatted"]
