...
/mob/new_player/proc/vote_on_poll(var/pollid = -1, var/optionid = -1, multichoice = 0)
...
/mob/new_player/proc/vote_on_numval_poll(var/pollid = -1, var/optionid = -1, rating = null)
	if(pollid == -1 || optionid == -1)
		return
