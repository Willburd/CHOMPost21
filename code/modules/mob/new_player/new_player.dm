...
/mob/new_player/proc/AttemptLateSpawn(rank)
	...
	/* Outpost 21 edit - Job Removal: //CHOMPEdit Begin - non-crew join don't get a message
...
/mob/new_player/proc/AnnounceCyborg(var/mob/living/character, var/rank, join_message, channel, zlevel)
...
/mob/new_player/hear_say(var/list/message_pieces, verb = "says", italics = 0, mob/speaker = null)
	return
