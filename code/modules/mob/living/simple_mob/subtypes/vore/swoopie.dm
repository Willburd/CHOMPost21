...
/mob/living/simple_mob/vore/aggressive/corrupthound/swoopie/ClickOn(var/atom/A, params)
...
/datum/ai_holder/simple_mob/retaliate/swoopie/find_target(var/list/possible_targets, has_targets_list = FALSE)
