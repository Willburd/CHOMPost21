...
/mob/living/simple_mob/vore/otie/attackby(var/obj/item/O, mob/user) // Trade donuts for bellybrig victims.
...
/mob/living/simple_mob/vore/otie/security/feed_grabbed_to_self(var/mob/living/user, mob/living/prey) // Make the gut start out safe for bellybrigging.
	if(ishuman(prey))
