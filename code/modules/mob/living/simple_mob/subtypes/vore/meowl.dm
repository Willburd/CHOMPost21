...
/mob/living/simple_mob/vore/meowl/attackby(var/obj/item/O as obj, mob/user as mob)
...
/mob/living/simple_mob/vore/meowl/PounceTarget(var/mob/living/M, successrate = 100)
