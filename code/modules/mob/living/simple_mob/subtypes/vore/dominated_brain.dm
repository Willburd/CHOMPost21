...
/mob/living/dominated_brain/Initialize(mapload, var/mob/living/pred, preyname, mob/living/prey)
	prey_name = preyname
	if(prey)
		prey_body = prey
	pred_body = pred
...
/mob/living/dominated_brain/say_understands(var/mob/other, datum/language/speaking = null)
