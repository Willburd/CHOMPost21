...
/mob/living/simple_mob/animal/borer/extra_huds(var/datum/hud/hud,var/icon/ui_style,list/hud_elements)
	// Chem hud
...
/mob/living/simple_mob/animal/borer/UnarmedAttack(var/atom/A, proximity)
	if(ismob(loc))
...
/mob/living/simple_mob/animal/borer/say(var/message, var/datum/language/speaking = null, whispering = 0)
