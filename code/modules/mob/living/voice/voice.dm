...
/mob/living/voice/say(var/message, var/datum/language/speaking = null, whispering = 0)
	//Speech bubbles.
	if(comm)
...
/mob/living/voice/say_understands(var/other, datum/language/speaking = null)
...
/mob/living/voice/custom_emote(var/m_type = VISIBLE_MESSAGE, var/message = null, range = world.view)
	if(comm)
