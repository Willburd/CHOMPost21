...
/mob/living/voice/say(var/message, datum/language/speaking = null, whispering = 0)
	//Speech bubbles.
	if(comm)
...
/mob/living/voice/custom_emote(var/m_type = VISIBLE_MESSAGE, message = null, range = world.view)
	if(comm)
