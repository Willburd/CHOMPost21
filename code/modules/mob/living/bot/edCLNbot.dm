...
/mob/living/bot/cleanbot/edCLN/emag_act(var/remaining_uses, mob/user)
	. = ..()
	if(!emagged)
		if(user)
...
/obj/item/secbot_assembly/edCLN_assembly/attackby(var/obj/item/W as obj, mob/user as mob)
	..()
