...
/mob/living/bot/secbot/ed209/slime/UnarmedAttack(var/mob/living/L, proximity)
	..()
...
/obj/item/secbot_assembly/ed209_assembly/slime/attackby(var/obj/item/W, mob/user) // Here in the event it's added into a PoI or some such. Standard construction relies on the standard ED up until taser.
