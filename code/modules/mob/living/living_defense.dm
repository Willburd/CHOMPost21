...
*/
/mob/living/proc/run_armor_check(var/def_zone = null, var/attack_flag = "melee", var/armour_pen = 0, var/absorb_text = null, soften_text = null)
	if(GLOB.Debug2)
...
/mob/living/proc/stun_effect_act(var/stun_amount, var/agony_amount, var/def_zone, var/used_weapon=null, electric = FALSE)
	flash_pain()
...
/mob/living/proc/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 1.0, var/def_zone = null, stun = 1)
...
/mob/living/proc/hit_with_weapon(obj/item/I, mob/living/user, var/effective_force, hit_zone)
...
/mob/living/proc/standard_weapon_hit_effects(obj/item/I, mob/living/user, var/effective_force, var/blocked, hit_zone)
...
/mob/living/proc/on_throw_vore_special(var/pred = TRUE, mob/living/target)
	return

/mob/living/proc/embed(var/obj/O, def_zone=null)
	O.loc = src
	src.embedded += O
...
/mob/living/proc/near_wall(var/direction,distance=1)
...
/mob/living/attack_generic(var/mob/user, var/damage, attack_message)
...
/mob/living/proc/can_inject(var/mob/user, var/error_msg, var/target_zone, ignore_thickness = FALSE)
	return 1
...
/mob/living/proc/take_organ_damage(var/brute, var/burn, emp=0)
	adjustBruteLoss(brute)
	adjustFireLoss(burn)
	src.updatehealth()
...
/mob/living/proc/take_overall_damage(var/brute, var/burn, used_weapon = null)
	adjustBruteLoss(brute)
	adjustFireLoss(burn)
	src.updatehealth()
