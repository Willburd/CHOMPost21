/mob/living/carbon/proc/ingest(var/datum/reagents/from, var/datum/reagents/target, amount = 1, multiplier = 1, copy = 0) //we kind of 'sneak' a proc in here for ingesting stuff so we can play with it.
