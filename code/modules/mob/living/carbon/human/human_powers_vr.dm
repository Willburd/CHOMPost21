...
/mob/living/carbon/human/proc/hand_games_check(var/mob/living/carbon/human/player1, mob/living/carbon/human/player2)
...
/mob/living/carbon/human/proc/game_rps(var/mob/living/carbon/human/player1, mob/living/carbon/human/player2)
...
/mob/living/carbon/human/proc/game_armwrestle(var/mob/living/carbon/human/player1, mob/living/carbon/human/player2)
	if(!hand_games_check(player1,player2))
		return
...
/mob/living/carbon/human/proc/game_slaphands(var/mob/living/carbon/human/player1, mob/living/carbon/human/player2)
	if(!hand_games_check(player1,player2))
		return
...
/mob/living/carbon/human/proc/game_thumbwars(var/mob/living/carbon/human/player1, mob/living/carbon/human/player2)
	if(!hand_games_check(player1,player2))
		return
