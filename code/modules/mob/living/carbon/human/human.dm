...
/mob/living/carbon/human/proc/get_full_print()
	if(!dna ||!dna.unique_enzymes) // Outpost 21 edit(port) - Hash of the hash of a player's name to keep consistency between respawns
		return
	return md5(dna.unique_enzymes) // Outpost 21 edit(port) - Hash of the hash of a player's name to keep consistency between respawns
