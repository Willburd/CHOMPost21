...
/datum/species/shadekin/produceCopy(var/list/traits, var/mob/living/carbon/human/H, custom_base, reset_dna = TRUE) // Traitgenes reset_dna flag required, or genes get reset on resleeve
