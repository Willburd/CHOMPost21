...
/datum/reagent/succubi_aphrodisiac/affect_blood(var/mob/living/carbon/M, var/alien, removed)
	if(prob(3))
...
/datum/reagent/succubi_numbing/affect_blood(var/mob/living/carbon/M, var/alien, removed)
...
/datum/reagent/succubi_paralize/affect_blood(var/mob/living/carbon/M, var/alien, removed) //will first keep it like that.  lets see what it changes. if nothing, than I will rework the effect again
