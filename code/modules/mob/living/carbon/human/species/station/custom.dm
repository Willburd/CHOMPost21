...
/datum/species/custom/produceCopy(var/list/traits, var/mob/living/carbon/human/H, var/custom_base, reset_dna = TRUE)
...
/datum/species/custom/equip_survival_gear(var/mob/living/carbon/human/H, var/extendedtank = 0, comprehensive = 0)
	. = ..()
