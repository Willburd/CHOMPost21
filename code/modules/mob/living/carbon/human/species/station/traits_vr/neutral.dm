...
/datum/trait/neutral/autohiss_unathi
	...
	excludes = list(/datum/trait/neutral/autohiss_tajaran, /datum/trait/neutral/autohiss_vassilian, /datum/trait/neutral/autohiss_zaddat, /datum/trait/neutral/autohiss_yinglet) // Outpost 21 edit - add yinglet // CHOMPEdit: exclude vassillian hiss
	custom_only = FALSE
...
/datum/trait/neutral/autohiss_tajaran
	...
	excludes = list(/datum/trait/neutral/autohiss_unathi, /datum/trait/neutral/autohiss_zaddat, /datum/trait/neutral/autohiss_vassilian, /datum/trait/neutral/autohiss_yinglet) // Outpost 21 edit - add yinglet // CHOMPEdit: exclude vassillian hiss
	custom_only = FALSE
	//banned_species = list(SPECIES_TAJARAN, SPECIES_UNATHI, SPECIES_ZADDAT) //CHOMPRemove
