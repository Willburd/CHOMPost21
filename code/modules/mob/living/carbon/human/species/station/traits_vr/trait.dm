/datum/trait
	...
	var/custom_only = FALSE			// Trait only available for custom species // Outpost 21 edit - Anyone can take this trait
	...
	var/addiction = null   // REAGENT_ID_X to give (or 0) // Outpost 21 edit - Addictions
