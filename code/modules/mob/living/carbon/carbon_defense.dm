...
/mob/living/carbon/resolve_item_attack(obj/item/I, mob/living/user, var/effective_force, hit_zone)
	if(check_neckgrab_attack(I, user, hit_zone))
		return null
	..()

/mob/living/carbon/standard_weapon_hit_effects(obj/item/I, mob/living/user, var/effective_force, var/blocked, hit_zone)
