...
/mob/living/silicon/stun_effect_act(var/stun_amount, var/agony_amount, var/def_zone, used_weapon=null, electric = FALSE)
	return	//immune

/mob/living/silicon/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 0.0, def_zone = null, stun = 1)
	if(shock_damage > 0)
...
/mob/living/silicon/apply_effect(var/effect = 0,var/effecttype = STUN, blocked = 0, check_protection = 1)
...
//can't inject synths
/mob/living/silicon/can_inject(var/mob/user, var/error_msg, target_zone, ignore_thickness = FALSE)
	if(error_msg)
