...
/mob/living/silicon/robot/drone/take_overall_damage(var/brute = 0, burn = 0, sharp = FALSE, used_weapon = null)
	bruteloss += brute
	fireloss += burn
...
/mob/living/silicon/robot/drone/take_organ_damage(var/brute = 0, burn = 0, sharp = FALSE, emp = 0)
