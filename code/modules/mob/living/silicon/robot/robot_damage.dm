...
/mob/living/silicon/robot/take_organ_damage(var/brute = 0, var/burn = 0, sharp = FALSE, edge = FALSE, emp = 0)
...
/mob/living/silicon/robot/take_overall_damage(var/brute = 0, burn = 0, sharp = FALSE, used_weapon = null)
