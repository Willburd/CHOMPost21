...
/mob/living/proc/harvest(var/mob/user, obj/item/I)
...
/mob/living/proc/can_butcher(var/mob/user, obj/item/I)	// Override for special butchering checks.
	if(((meat_type && meat_amount) || LAZYLEN(butchery_loot)) && stat == DEAD)
		return TRUE

	return FALSE

/mob/living/proc/handle_butcher(var/mob/user, obj/item/I)
