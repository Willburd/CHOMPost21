...
/datum/antagonist/add_antagonist(datum/mind/player, ignore_role, do_not_equip, move_to_spawn, do_not_announce, preserve_appearance) // Outpost 21 edit(port) - Missing arguments
	. = ..()
	if(src == GLOB.cult)
