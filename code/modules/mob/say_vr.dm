...
/mob/proc/custom_emote_vr(var/m_type=1,var/message = null,mode_selection = FALSE) //This would normally go in emote.dm
...
/mob/proc/emote_vr(var/act, var/type, var/message, mode_selection) //This would normally go in say.dm
	if(act == "me")
