...
/datum/tgui_state/glasses_state/can_use_topic(var/src_object, mob/user)
	if(ishuman(user))
...
/datum/tgui_state/nif_state/can_use_topic(var/src_object, mob/user)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
...
/datum/tgui_state/nif_main_state/can_use_topic(var/src_object, mob/user)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
...
/datum/tgui_state/commlink_state/can_use_topic(var/src_object, mob/user)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
