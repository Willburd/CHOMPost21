...
/obj/item/organ/external/head/robotize(var/company, var/skip_prosthetics, keep_organs)
...
/obj/item/organ/external/head/get_icon(var/skeletal, can_apply_transparency = TRUE)
	..()
