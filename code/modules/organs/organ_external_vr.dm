...
/obj/item/organ/external/robotize(var/company, var/skip_prosthetics = FALSE, keep_organs = FALSE)
...
/obj/item/organ/external/digitize(var/company, var/skip_prosthetics = FALSE, keep_organs = FALSE)
