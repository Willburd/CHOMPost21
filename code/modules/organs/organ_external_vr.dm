...
/obj/item/organ/external/robotize(var/company, skip_prosthetics = FALSE, keep_organs = FALSE)
...
/obj/item/organ/external/digitize(var/company, skip_prosthetics = FALSE, keep_organs = FALSE)
