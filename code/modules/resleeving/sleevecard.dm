...
/obj/item/paicard/sleevecard/proc/sleeveInto(var/datum/transhuman/mind_record/MR, db_key)
...
/mob/living/silicon/pai/infomorph/Initialize(mapload, var/our_name = "Unknown", db_key)
	. = ..()
