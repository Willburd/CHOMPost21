...
GLOBAL_LIST_INIT(VVpixelmovement, list("bound_x", "bound_y", "step_x_ISSUEHERE", "step_y_ISSUEHERE", "step_size", "bound_height_ISSUEHERE", "bound_width_ISSUEHERE", "bounds"))		//No editing ever.
