...
/obj/item/material/fishing_net/afterattack(var/atom/A, var/mob/user, proximity)
...
/obj/item/material/fishing_net/attackby(var/obj/item/W, mob/user)
	if(contents)
...
/obj/item/material/fishing_net/butterfly_net/afterattack(var/atom/A, var/mob/user, proximity)
	if(get_dist(get_turf(src), A) > reach)
		return
