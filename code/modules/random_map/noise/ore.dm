	...
	for(var/i=0,i<chunk_size,i++)
		for(var/j=0,j<chunk_size,j++)
			...
			if(current_cell < rare_val)      // Surface metals.
				...
				T.resources[ORE_COPPER] =   rand(RESOURCE_MID_MIN, RESOURCE_HIGH_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_TIN] =      rand(RESOURCE_LOW_MIN, RESOURCE_MID_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_BAUXITE] =  rand(RESOURCE_LOW_MIN, RESOURCE_LOW_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_RUTILE] =   0
				T.resources[ORE_VOPAL] = 0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_QUARTZ] = 0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_PAINITE] = 0 // Outpost 21 edit begin - Restored older ores
				...
				T.resources[ORE_COPPER] =   0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_TIN] =      rand(RESOURCE_MID_MIN, RESOURCE_MID_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_BAUXITE] =  0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_RUTILE] =   0
				T.resources[ORE_VOPAL] = 0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_QUARTZ] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_PAINITE] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX) // Outpost 21 edit begin - Restored older ores
			else                             // Deep metals.
				T.resources[ORE_URANIUM] =  rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				...
				T.resources[ORE_COPPER] =   0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_TIN] =      0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_BAUXITE] =  0 // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_RUTILE] =   0
				T.resources[ORE_VOPAL] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_QUARTZ] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX) // Outpost 21 edit begin - Restored older ores
				T.resources[ORE_PAINITE] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX) // Outpost 21 edit begin - Restored older ores
	return
