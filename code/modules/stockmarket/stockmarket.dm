...
/datum/stockMarket/proc/balanceLog(var/whose, net)
...
/datum/stockMarket/proc/add_log(var/log_type, var/user, var/company_name, var/stocks, var/shareprice, money)
...
/proc/plotBarGraph(var/list/points, var/base_text, var/width=400, height=400)
