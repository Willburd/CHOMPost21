...
/proc/get_humanoid_displacement_map_image(var/mob/living/carbon/human/target,var/list/discarded_layer_indicies, icon/displacement_map, outlineWidth = 0, render_target = null)
