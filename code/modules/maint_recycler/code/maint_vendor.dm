...
/obj/machinery/maint_vendor/fall_apart(var/severity = 3, scatter = TRUE)
...
/obj/machinery/maint_vendor/proc/attempt_purchase(var/mob/user, datum/maint_recycler_vendor_entry/entry)
	if(!istype(entry))
		return
...
/obj/machinery/maint_vendor/proc/purchase_failed(var/mob/user, reason)
	if(prob(95))
...
/obj/machinery/maint_vendor/proc/dispense_item_from_datum(var/mob/user, datum/maint_recycler_vendor_entry/used_entry)
...
/obj/machinery/maint_vendor/proc/can_user_purchase(var/mob/user,datum/maint_recycler_vendor_entry/attempted_entry)
...
/obj/machinery/maint_vendor/proc/set_screen_state(var/state, duration = 10)
	if(!is_on) return
...
/obj/machinery/maint_vendor/proc/credit_user(var/mob/user, amount)
