...
/obj/structure/event_collector_blocker/proc/pre_repair_handling(var/obj/item/O,var/toolType,mob/user) //can we use this tool?
	switch(toolType)
		if(TOOL_WELDER)
...
/obj/structure/event_collector_blocker/proc/post_repair_handling(var/obj/item/O,var/toolType,mob/user)
