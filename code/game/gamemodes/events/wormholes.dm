/proc/wormhole_event(var/set_duration = 5 MINUTES, var/wormhole_duration_modifier = 1, redspace = FALSE)
	spawn()
...
/proc/create_wormhole(var/turf/enter as turf, var/atom/exit, var/min_duration = 30 SECONDS, max_duration = 60 SECONDS) // CHOMPEdit
	set waitfor = FALSE
