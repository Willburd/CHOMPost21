...
/obj/effect/bhole/proc/grav(var/r, var/ex_act_force, pull_chance, turf_removal_chance)
...
/obj/effect/bhole/proc/affect_coord(var/x, var/y, var/ex_act_force, pull_chance, turf_removal_chance)
