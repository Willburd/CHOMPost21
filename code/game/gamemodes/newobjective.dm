...
/proc/GenerateTheft(var/job,datum/mind/traitor)
...
/proc/GenerateAssassinate(var/job,datum/mind/traitor)
...
/proc/GenerateFrame(var/job,datum/mind/traitor)
...
/proc/GenerateProtection(var/job,datum/mind/traitor)
	var/list/datum/objective/frame/missions = list()
...
/proc/SelectObjectives(var/job,var/datum/mind/traitor,hijack = 0)
