...
/obj/item/mecha_parts/mecha_equipment/proc/handle_ranged_contact(var/obj/A, inc_damage = 0)
	return max(0, inc_damage)

// Used for melee strikes with an object, and a mob, and damage value.
/obj/item/mecha_parts/mecha_equipment/proc/handle_melee_contact(var/obj/item/W, var/mob/living/user, inc_damage = 0)
	return max(0, inc_damage)

// Used for projectile impacts from bullet_act.
/obj/item/mecha_parts/mecha_equipment/proc/handle_projectile_contact(var/obj/item/projectile/Proj, inc_damage = 0)
	return max(0, inc_damage)
