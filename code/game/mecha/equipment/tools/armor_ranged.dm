...
/obj/item/mecha_parts/mecha_equipment/antiproj_armor_booster/handle_projectile_contact(var/obj/item/projectile/Proj, inc_damage)
...
/obj/item/mecha_parts/mecha_equipment/antiproj_armor_booster/handle_ranged_contact(var/obj/A, inc_damage = 0)
	if(!action_checks(A))
		return inc_damage
	if(prob(chassis.deflect_chance*deflect_coeff))
