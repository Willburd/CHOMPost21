...
/datum/dna/gene/basic/remoteview/activate(var/mob/M, var/connected, flags)
	..(M,connected,flags)
...
/datum/dna/gene/basic/remotetalk/activate(var/mob/M, var/connected, flags)
	..(M,connected,flags)
...
/datum/dna/gene/basic/cold_resist/can_activate(var/mob/M,flags)
...
/datum/dna/gene/basic/cold_resist/OnDrawUnderlays(var/mob/M,var/g,fat)
	return "fire[fat]_s"
...
/datum/dna/gene/basic/midget/can_activate(var/mob/M,flags)
	// Can't be big and small.
	if(HULK in M.mutations)
		return 0
	return ..(M,flags)

/datum/dna/gene/basic/midget/activate(var/mob/M, var/connected, flags)
	..(M,connected,flags)
	M.pass_flags |= 1

/datum/dna/gene/basic/midget/deactivate(var/mob/M, var/connected, flags)
	..(M,connected,flags)
...
/datum/dna/gene/basic/hulk/can_activate(var/mob/M,flags)
	// Can't be big and small.
	if(mSmallsize in M.mutations)
		return 0
	return ..(M,flags)

/datum/dna/gene/basic/hulk/OnDrawUnderlays(var/mob/M,var/g,fat)
	if(fat)
		return "hulk_[fat]_s"
	else
		return "hulk_[g]_s"
...
/datum/dna/gene/basic/tk/New()
	block=TELEBLOCK
/datum/dna/gene/basic/tk/OnDrawUnderlays(var/mob/M,var/g,fat)
