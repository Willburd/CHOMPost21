...
/datum/dna/gene/disability/activate(var/mob/M, var/connected, flags)
...
/datum/dna/gene/disability/deactivate(var/mob/M, var/connected, flags)
	if(mutation && (mutation in M.mutations))
...
/datum/dna/gene/disability/deaf/activate(var/mob/M, var/connected, flags)
	..(M,connected,flags)
	M.ear_deaf = 1
