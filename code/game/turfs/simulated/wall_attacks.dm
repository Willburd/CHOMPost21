...
/turf/simulated/wall/attack_generic(var/mob/user, var/damage, attack_message)
...
/turf/simulated/wall/attackby(var/obj/item/W, mob/user, attack_modifier, click_parameters)
