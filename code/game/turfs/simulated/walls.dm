...
/turf/simulated/wall/ChangeTurf(var/turf/N, var/tell_universe, var/force_lighting_update, preserve_outdoors)
	clear_plants()
...
/turf/simulated/wall/proc/dismantle_wall(var/devastated, var/explode, no_product)
