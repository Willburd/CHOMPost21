...
/turf/simulated/floor/proc/cause_slip(var/mob/living/M) // Outpost 21 edit - Experimental - Remove sleep(), without this it will runtime failing to resolve a timer proc if a turf changes during a slip
	return
