...
/turf/simulated/floor/gas_crack/pump_reagents(var/datum/reagents/R, volume)
...
/turf/simulated/floor/gas_crack/oxygen/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
...
/turf/simulated/floor/gas_crack/nitrogen/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
...
/turf/simulated/floor/gas_crack/carbon/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
...
/turf/simulated/floor/gas_crack/nitro/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
...
/turf/simulated/floor/gas_crack/phoron/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
...
/turf/simulated/floor/gas_crack/air/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
	R.add_reagent(REAGENT_ID_OXYGEN, round(volume / 2, 0.1))
	R.add_reagent(REAGENT_ID_NITROGEN, round(volume / 2, 0.1))
...
/turf/simulated/floor/gas_crack/methane/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
...
/turf/simulated/floor/gas_crack/terrible/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
	R.add_reagent(REAGENT_ID_NITROGEN, round(volume / 2, 0.1))
	R.add_reagent(REAGENT_ID_SULFUR, round(volume / 2, 0.1))
	R.add_reagent(REAGENT_ID_PHOSPHORUS, round(volume / 2, 0.1))
...
/turf/simulated/floor/gas_crack/random/pump_reagents(var/datum/reagents/R, volume)
	. = ..()
