 ...
 * @pipe_type
 */
/obj/item/pipe/Initialize(mapload, var/_pipe_type, var/_dir, obj/machinery/atmospherics/make_from)
	if(make_from)
...
/obj/item/pipe/attackby(var/obj/item/W as obj, mob/user as mob)
	if(W.has_tool_quality(TOOL_WRENCH))
		return wrench_act(user, W)
	return ..()

/obj/item/pipe/proc/wrench_act(var/mob/living/user, obj/item/tool/wrench/W)
	if(!isturf(loc))
		return TRUE
...
/obj/item/pipe_meter/attackby(var/obj/item/W as obj, mob/user as mob)
	if(W.has_tool_quality(TOOL_WRENCH))
		return wrench_act(user, W)
	return ..()

/obj/item/pipe_meter/proc/wrench_act(var/mob/living/user, obj/item/tool/wrench/W)
