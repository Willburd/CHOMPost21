...
/obj/machinery/computer/cloning
	...
	var/obj/item/disk/body_record/diskette = null //Mostly so the geneticist can steal everything. Traitgenes edit - Storing the entire body record
...
/obj/machinery/computer/cloning/attackby(obj/item/W as obj, mob/user as mob, params)
	if(istype(W, /obj/item/disk/body_record/)) //INSERT SOME DISKETTES Traitgenes edit - Storing the entire body record
		if(!diskette)
			user.drop_item()
			W.loc = src
			diskette = W
