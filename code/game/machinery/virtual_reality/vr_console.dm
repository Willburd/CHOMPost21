...
/obj/machinery/vr_sleeper/attackby(var/obj/item/I, mob/user)
...
/obj/machinery/vr_sleeper/MouseDrop_T(var/mob/target, mob/user)
...
/obj/machinery/vr_sleeper/proc/go_in(var/mob/M, mob/user)
	if(!M)
		return
