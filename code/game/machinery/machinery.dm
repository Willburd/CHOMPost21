...
/obj/machinery/vv_edit_var(var/var_name, new_value)
...
/obj/machinery/proc/default_part_replacement(var/mob/user, obj/item/storage/part_replacer/R)
...
/obj/machinery/proc/default_unfasten_wrench(var/mob/user, var/obj/item/W, time = 0)
...
/obj/machinery/proc/alarm_deconstruction_screwdriver(var/mob/user, obj/item/S)
	if(!S.has_tool_quality(TOOL_SCREWDRIVER))
		return 0
	playsound(src, S.usesound, 50, 1)
	panel_open = !panel_open
...
/obj/machinery/proc/alarm_deconstruction_wirecutters(var/mob/user, obj/item/W)
 ...
 */
/obj/machinery/proc/fall_apart(var/severity = 3, scatter = TRUE)
