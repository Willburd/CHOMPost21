/obj
	layer = OBJ_LAYER
	plane = OBJ_PLANE
	vis_flags_ISSUEHERE = VIS_INHERIT_PLANE //when this be added to vis_contents of something it inherit something.plane, important for visualisation of obj in openspace.
