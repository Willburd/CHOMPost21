...
/obj/item/proc/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, attack_text = "the attack")
	return 0
...
/obj/item/proc/zoom(var/mob/living/M, var/tileoffset = 14,viewsize = 9) //tileoffset is client view offset in the direction the user is facing. viewsize is how far out this thing zooms. 7 is normal view
	SIGNAL_HANDLER
...
/obj/item/proc/attack_can_reach(var/atom/us, var/atom/them, range)
	if(us.Adjacent(them))
...
/obj/item/proc/make_worn_icon(var/body_type,var/slot_name,var/inhands,var/default_icon,var/default_layer,icon/clip_mask = null)
...
/obj/item/proc/get_worn_icon_file(var/body_type,var/slot_name,var/default_icon,inhands)
...
/obj/item/proc/apply_addblends(var/source_icon, icon/standing_icon)
