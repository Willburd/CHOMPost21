...
/obj/item/kit/proc/use(var/amt, mob/user)
	uses -= amt
...
/obj/item/kit/proc/set_info(var/kit_name, var/kit_desc, var/kit_icon, var/kit_icon_file = CUSTOM_ITEM_OBJ, var/kit_icon_override_file = CUSTOM_ITEM_MOB, additional_data)
	new_name = kit_name
	new_desc = kit_desc
	new_icon = kit_icon
...
/obj/item/kit/proc/customize(var/obj/item/I, mob/user)
	if(can_customize(I))
...
/obj/item/kit/suit/set_info(var/kit_name, var/kit_desc, var/kit_icon, var/kit_icon_file = CUSTOM_ITEM_OBJ, var/kit_icon_override_file = CUSTOM_ITEM_MOB, additional_data)
	..()

	new_light_overlay = additional_data


/obj/item/kit/suit/customize(var/obj/item/I, mob/user)
	if(can_customize(I))
...
/obj/item/clothing/suit/storage/hooded/attackby(var/obj/item/O, mob/user)
	if(istype(O,/obj/item/kit/suit))
		var/obj/item/kit/suit/kit = O
		kit.customize(src, user)
		return
...
/obj/item/kit/suit/rig/customize(var/obj/item/I, mob/user)
...
/obj/item/rig/attackby(var/obj/item/O, mob/user)
	if(istype(O,/obj/item/kit/suit))
...
/obj/item/kit/paint/set_info(var/kit_name, var/kit_desc, var/kit_icon, var/kit_icon_file = CUSTOM_ITEM_OBJ, var/kit_icon_override_file = CUSTOM_ITEM_MOB, additional_data)
	..()
...
/obj/item/kit/paint/customize(var/obj/mecha/M, mob/user)
	if(!can_customize(M))
...
/obj/mecha/attackby(var/obj/item/W, mob/user)
