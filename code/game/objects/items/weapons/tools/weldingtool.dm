...
/obj/item/weldingtool/proc/remove_fuel(var/amount = 1, mob/M = null)
	if(!welding)
		return 0
	if(amount)
...
/obj/item/weldingtool/proc/setWelding(var/set_welding, mob/M)
	if(!status)	return
...
/obj/item/weldingtool/electric/remove_fuel(var/amount = 1, mob/M = null)
	if(!welding)
		return 0
	if(get_fuel() >= amount)
...
/obj/item/weldingtool/dummy/remove_fuel(var/amount = 1, mob/M = null)
	return TRUE
