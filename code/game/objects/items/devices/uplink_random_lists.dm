...
/datum/uplink_random_item/New(var/uplink_item, var/keep_probability = 100, reselect_propbability = 33)
	..()
...
/datum/uplink_random_selection/proc/get_random_item(var/telecrystals, var/obj/item/uplink/U, var/list/bought_items, items_override = 0)
