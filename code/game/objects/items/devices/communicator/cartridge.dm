...
/obj/item/commcard/proc/post_status(var/command, var/data1, data2)
...
/obj/item/commcard/receive_signal(var/datum/signal/signal, var/receive_method, receive_param)
