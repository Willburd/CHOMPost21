...
/obj/item/device/uplink/proc/get_item_cost(var/item_type, var/item_cost) // Outpost 21 edit - Removed ancient retail system (made a proc in uplink instead of inherited)
