...
/obj/structure/low_wall/attackby(var/obj/item/W, var/mob/user, var/hit_modifier, click_parameters)
...
/obj/structure/low_wall/attack_generic(var/mob/user, var/damage, attack_verb)
