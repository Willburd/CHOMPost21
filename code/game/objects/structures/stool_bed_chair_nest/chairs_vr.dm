...
/obj/structure/bed/chair/modern_chair/Initialize(mapload, var/new_material, new_padding_material)
	. = ..()
...
/obj/structure/bed/chair/bay/chair/padded/red/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CARPET)

/obj/structure/bed/chair/bay/chair/padded/brown/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BROWN)

/obj/structure/bed/chair/bay/chair/padded/teal/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_TEAL)

/obj/structure/bed/chair/bay/chair/padded/black/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BLACK)

/obj/structure/bed/chair/bay/chair/padded/green/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_GREEN)

/obj/structure/bed/chair/bay/chair/padded/purple/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_PURPLE)

/obj/structure/bed/chair/bay/chair/padded/blue/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BLUE)

/obj/structure/bed/chair/bay/chair/padded/beige/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BEIGE)

/obj/structure/bed/chair/bay/chair/padded/lime/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_LIME)

/obj/structure/bed/chair/bay/chair/padded/yellow/Initialize(mapload, var/new_material, new_padding_material)
...
/obj/structure/bed/chair/bay/comfy/red/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CARPET)

/obj/structure/bed/chair/bay/comfy/brown/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BROWN)

/obj/structure/bed/chair/bay/comfy/teal/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_TEAL)

/obj/structure/bed/chair/bay/comfy/black/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BLACK)

/obj/structure/bed/chair/bay/comfy/green/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_GREEN)

/obj/structure/bed/chair/bay/comfy/purple/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_PURPLE)

/obj/structure/bed/chair/bay/comfy/blue/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BLUE)

/obj/structure/bed/chair/bay/comfy/beige/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_BEIGE)

/obj/structure/bed/chair/bay/comfy/lime/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_LIME)

/obj/structure/bed/chair/bay/comfy/yellow/Initialize(mapload, var/new_material, new_padding_material)
	. = ..(mapload, new_material, MAT_CLOTH_YELLOW)
...
/obj/structure/bed/chair/bay/comfy/captain/Initialize(mapload, var/new_material, new_padding_material)
...
/obj/structure/bed/chair/bay/shuttle/Initialize(mapload, var/new_material, new_padding_material)
