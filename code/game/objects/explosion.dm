...
/proc/explosion(turf/epicenter, devastation_range, heavy_impact_range, light_impact_range, flash_range, adminlog = 1, z_transfer = UP|DOWN, shaped)
	...
	spawn(0)
		...
		var/y0 = epicenter.y
		var/z0 = epicenter.z
		if(CONFIG_GET(flag/use_recursive_explosions) && heavy_impact_range < 100) // CHOMPEdit // Outpost 21 edit - Explosions under 100(heavy) can be recursive... Otherwise it'll kill server
