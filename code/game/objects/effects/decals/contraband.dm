...
/obj/item/contraband/poster/afterattack(var/atom/A, var/mob/user, var/adjacent, clickparams)
	if (!adjacent)
		return
...
/obj/structure/sign/poster/Initialize(mapload, var/placement_dir=null, var/serial=null, itemtype = /obj/item/contraband/poster)
	. = ..()
...
/obj/structure/sign/poster/nanotrasen/Initialize(mapload, var/placement_dir=null, var/serial=null, itemtype = /obj/item/contraband/poster/nanotrasen)
	if(!serial)
