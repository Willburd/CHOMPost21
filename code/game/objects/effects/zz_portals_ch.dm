...
/obj/effect/simple_portal/linked/Initialize()
	. = ..()
	if(portal_id)
		link_portal() // Outpost 21 edit - Removing sleeps from init. Recomendation: Contains sinful get_all_of_type() whichcalls stoplag/CHECKTICK... I dunno what to do. does this really need a stoplag call?
