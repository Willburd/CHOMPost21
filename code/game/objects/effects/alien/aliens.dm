...
/obj/effect/alien/weeds/Initialize(mapload, var/node, newcolor)
	. = ..()
...
/obj/effect/alien/weeds/node/Initialize(mapload, var/node, newcolor)
	. = ..()
...
/obj/effect/alien/weeds/attackby(var/obj/item/W, mob/user)
...
/obj/effect/alien/weeds/attack_generic(var/mob/user, var/damage, attack_verb)
