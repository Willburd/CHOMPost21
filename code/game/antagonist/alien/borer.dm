...
/datum/antagonist/borer
	...
	mob_path = /mob/living/simple_mob/animal/borer/roundstart // Outpost 21 edit - Use roundstart borer, or ghostcheck makes it take forever to enter mob when assigned
	bantype = "Borer"
