...
/datum/antagonist/revolutionary
	...
	avoid_silicons = TRUE
	protected_jobs = list(JOB_SECURITY_OFFICER, JOB_WARDEN, /*JOB_DETECTIVE,*/ JOB_INTERNAL_AFFAIRS_AGENT, JOB_SITE_MANAGER, JOB_HEAD_OF_PERSONNEL, JOB_HEAD_OF_SECURITY, JOB_CHIEF_ENGINEER, JOB_RESEARCH_DIRECTOR, JOB_CHIEF_MEDICAL_OFFICER) // Outpost 21 edit - Detective is officer now
