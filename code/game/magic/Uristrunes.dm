...
/proc/get_uristrune(symbol_bits, animated = 0)
	...
	I.SwapColor_ISSUEHERE(rgb(0, 0, 0, 100), rgb(100, 0, 0, 200))
	I.SwapColor_ISSUEHERE(rgb(0, 0, 0, 50), rgb(150, 0, 0, 200))
		...
		for(var/y = 1, y <= 32, y++)
			...
			if(p == null)
				...
				if(n == "#000000" || s == "#000000" || e == "#000000" || w == "#000000")
					I.DrawBox_ISSUEHERE(rgb(200, 0, 0, 200), x, y)
					...
					if(ne == "#000000" || se == "#000000" || nw == "#000000" || sw == "#000000")
						I.DrawBox_ISSUEHERE(rgb(200, 0, 0, 100), x, y)
	...
	if(animated == 1)
		var/icon/I2 = icon(I, "")
		I2.MapColors_ISSUEHERE(rgb(0xff,0x0c,0,0), rgb(0,0,0,0), rgb(0,0,0,0), rgb(0,0,0,0xff))
		I2.SetIntensity_ISSUEHERE(1.04)

		var/icon/I3 = icon(I, "")
		I3.MapColors_ISSUEHERE(rgb(0xff,0x18,0,0), rgb(0,0,0,0), rgb(0,0,0,0), rgb(0,0,0,0xff))
		I3.SetIntensity_ISSUEHERE(1.08)

		var/icon/I4 = icon(I, "")
		I4.MapColors_ISSUEHERE(rgb(0xff,0x24,0,0), rgb(0,0,0,0), rgb(0,0,0,0), rgb(0,0,0,0xff))
		I4.SetIntensity_ISSUEHERE(1.12)

		var/icon/I5 = icon(I, "")
		I5.MapColors_ISSUEHERE(rgb(0xff,0x30,0,0), rgb(0,0,0,0), rgb(0,0,0,0), rgb(0,0,0,0xff))
		I5.SetIntensity_ISSUEHERE(1.16)
