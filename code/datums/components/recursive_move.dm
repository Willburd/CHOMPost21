...
/datum/component/recursive_move/proc/top_moved(var/atom/movable/am, atom/new_loc, atom/old_loc)
	SIGNAL_HANDLER
	SEND_SIGNAL(holder, COMSIG_MOVABLE_ATTEMPTED_MOVE, old_loc, new_loc)

//One of the parents other than the top parent moved.
/datum/component/recursive_move/proc/heirarchy_changed(var/atom/old_loc, atom/movable/am, atom/new_loc)
	SIGNAL_HANDLER
	SEND_SIGNAL(holder, COMSIG_MOVABLE_ATTEMPTED_MOVE, old_loc, new_loc)
...
/obj/item/bananapeel/test/proc/shmove(var/atom/source, atom/old_loc, atom/new_loc)
	SIGNAL_HANDLER
