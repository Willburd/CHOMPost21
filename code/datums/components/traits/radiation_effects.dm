...
/datum/component/radiation_effects/proc/handle_irradiate_effect(var/mob/living/living_guy, var/effect, var/effecttype, var/blocked, check_protection, rad_protection)
	SIGNAL_HANDLER
