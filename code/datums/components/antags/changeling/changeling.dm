...
/mob/proc/changeling_power(var/required_chems=0, var/required_dna=0, var/max_genetic_damage=100, max_stat=0)
...
/mob/proc/changeling_sting(var/required_chems=0, verb_path)
...
/datum/component/antag/changeling/proc/purchasePower(var/mob/owner, var/Pname, remake_verbs = 1)
