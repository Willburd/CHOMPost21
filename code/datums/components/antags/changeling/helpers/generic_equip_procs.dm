...
/mob/proc/changeling_generic_armor(var/armor_type, var/helmet_type, boot_type, chem_cost)
...
/mob/proc/changeling_generic_weapon(var/weapon_type, make_sound = 1, cost = 20)
	var/datum/component/antag/changeling/changeling = changeling_power(cost,1,100,CONSCIOUS)
	if(!changeling)
		return
