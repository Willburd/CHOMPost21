...
/datum/element/sellable/proc/sell(obj/source, var/datum/exported_crate/EC, in_crate)
	SIGNAL_HANDLER
...
/datum/element/sellable/trolley_tank/sell(obj/source, var/datum/exported_crate/EC, in_crate)
	. = ..()
	var/obj/vehicle/train/trolley_tank/tank = source
