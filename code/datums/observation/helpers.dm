/*
/atom/movable/proc/recursive_move(var/atom/movable/am, var/old_loc, new_loc)
	SEND_SIGNAL(src, COMSIG_MOVABLE_ATTEMPTED_MOVE, old_loc, new_loc)
*/
/atom/movable/proc/move_to_destination(var/atom/movable/am, var/old_loc, new_loc)
	var/turf/T = get_turf(new_loc)
	if(T && T != loc)
		forceMove(T)

/atom/proc/recursive_dir_set(var/atom/a, var/old_dir, new_dir)
	set_dir(new_dir)
...
/*
/proc/register_all_movement(var/event_source, datum/listener)
...
/proc/unregister_all_movement(var/event_source, datum/listener)
