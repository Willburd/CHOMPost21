...
/datum/uplink_item/abstract/announcements/buy(var/obj/item/uplink/U, mob/user)
	. = ..()
	if(.)
...
/datum/uplink_item/abstract/announcements/fake_centcom/get_goods(var/obj/item/uplink/U, var/location, var/mob/user, list/arguments)
...
/datum/uplink_item/abstract/announcements/fake_crew_arrival/get_goods(var/obj/item/uplink/U, var/location, var/mob/user, list/arguments)
	if(!user)
		return 0
...
/datum/uplink_item/abstract/announcements/fake_ion_storm/get_goods(var/obj/item/uplink/U, location)
...
/datum/uplink_item/abstract/announcements/fake_radiation/get_goods(var/obj/item/uplink/U, location)
