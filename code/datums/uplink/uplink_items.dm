...
/datum/uplink_item/proc/buy(var/obj/item/uplink/U, mob/user)
...
/datum/uplink_item/proc/can_buy(var/obj/item/uplink/U, telecrystals)
	if(cost(U, telecrystals) > telecrystals)
		return FALSE

	return TRUE

/datum/uplink_item/proc/cost(var/obj/item/uplink/U, telecrystals)
	. = item_cost
	if(U)
		. = U.get_item_cost(src, .)
...
/datum/uplink_item/proc/get_goods(var/obj/item/uplink/U, var/location, mob/user)
	return FALSE
...
* Support procs *
****************/
/proc/get_random_uplink_items(var/obj/item/uplink/U, var/remaining_TC, location)
...
/proc/get_surplus_items(var/obj/item/uplink/U, var/remaining_TC, location)
	var/list/bought_items = list()
	var/override = TRUE
	while(remaining_TC)
