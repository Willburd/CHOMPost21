...
/datum/exonet_protocol/proc/receive_message(var/atom/origin_atom, origin_address, data_type, content)
...
/atom/proc/receive_exonet_message(var/atom/origin_atom, origin_address, message, text)
	return
