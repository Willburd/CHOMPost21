...
/obj/machinery/atmospherics/trinary/attackby(var/obj/item/W as obj, mob/user as mob)
...
/proc/get_initialize_directions_trinary(var/dir, var/mirrored = FALSE, tee = FALSE)
	if(tee)
		switch(dir)
			if(NORTH)
...
/proc/get_node_connect_dirs_trinary(var/dir, var/mirrored = FALSE, tee = FALSE)
	var/node1_connect
	var/node2_connect
	var/node3_connect
