...
/datum/controller/subsystem/radio/proc/add_object(obj/device as obj, var/new_frequency as num, radio_filter = null as text|null)
...
/datum/radio_frequency/proc/post_signal(obj/source as obj|null, datum/signal/signal, var/radio_filter = null as text|null, range = null as num|null)
...
/datum/radio_frequency/proc/send_to_filter(obj/source, datum/signal/signal, var/radio_filter, var/turf/start_point = null, range = null)
