...
/datum/controller/subsystem/supply/proc/approve_order(var/datum/supply_order/O, mob/user)
...
/datum/controller/subsystem/supply/proc/deny_order(var/datum/supply_order/O, mob/user)
	// Based on the current model, there shouldn't be any entries in order_history, requestlist, or shoppinglist, that aren't matched in adm_order_history
	var/datum/supply_order/adm_order
	for(var/datum/supply_order/temp in adm_order_history)
		if(temp.ordernum == O.ordernum)
...
/datum/controller/subsystem/supply/proc/delete_order(var/datum/supply_order/O, mob/user)
...
/datum/controller/subsystem/supply/proc/create_order(var/datum/supply_pack/S, var/mob/user, reason)
...
/datum/controller/subsystem/supply/proc/delete_export(var/datum/exported_crate/E, mob/user)
	// Making sure they know what they're doing
...
/datum/controller/subsystem/supply/proc/add_export_item(var/datum/exported_crate/E, mob/user)
