...
/datum/controller/subsystem/motiontracker/proc/ping(var/atom/source, hear_chance = 30)
...
/datum/controller/subsystem/motiontracker/proc/queue_echo(var/turf/Rt,var/turf/At,var/echo_count = 1,datum/weakref/client)
	if(!Rt || !At || !client)
		return
	var/rfe = REF(At)
