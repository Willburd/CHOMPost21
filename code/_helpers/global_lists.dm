...
*/
	...
	var/list/whitelisted_icons = list(SPECIES_FENNEC,SPECIES_XENOHYBRID, SPECIES_SHADEKIN, SPECIES_TESHARI, SPECIES_VOX) //CHOMPedit, Outpost 21 edit - added tesh and vox bases
