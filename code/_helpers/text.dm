...
/proc/pencode2html(t)
	...
	t = replacetext(t, "\[pclogo\]", "<img src=\ref['html/images/pclogo.png']")
	// Outpost 21 edit - end
...
/proc/html2pencode(t)
	...
	t = replacetext(t, "<img src=\ref['html/images/outpost/eslogo.png']>", "\[logo\]")
	...
	t = replacetext(t, "<img src=\ref['html/images/pclogo.png']>", "\[pclogo\]")
	// Outpost 21 edit end
